...
* [bulkAddInviteTargetUsers](docs/sdks/discord/README.md#bulkaddinvitetargetusers) - Add multiple target users to an existing invite.
* [bulkRemoveInviteTargetUsers](docs/sdks/discord/README.md#bulkremoveinvitetargetusers) - Remove multiple target users from an existing invite.
...
* [addInviteTargetUser](docs/sdks/discord/README.md#addinvitetargetuser) - Add a target user to an existing invite.
* [removeInviteTargetUser](docs/sdks/discord/README.md#removeinvitetargetuser) - Remove a target user from an existing invite.
