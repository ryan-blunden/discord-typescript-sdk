 ...
 */
export function guildsDeleteIntegration(
  client: DiscordCore,
  request: operations.DeleteGuildIntegrationRequest,
  options?: RequestOptions,
): APIPromise<
  Result<
    operations.DeleteGuildIntegrationResponse | undefined,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.DeleteGuildIntegrationRequest$outboundSchema.parse(value),
  ...
  const path = pathToFunc("/guilds/{guild_id}/integrations/{integration_id}")(
    pathParams,
  );
  ...
  >(
    M.nil(
      204,
      operations.DeleteGuildIntegrationResponse$inboundSchema.optional(),
      { hdrs: true },
    ),
