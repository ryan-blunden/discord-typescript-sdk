...
export function createLinkedLobbyGuildInviteForUser(
  client: DiscordCore,
  request: operations.CreateLinkedLobbyGuildInviteForUserRequest,
  options?: RequestOptions,
): APIPromise<
  Result<
    operations.CreateLinkedLobbyGuildInviteForUserResponse,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.CreateLinkedLobbyGuildInviteForUserRequest$outboundSchema
        .parse(value),
  ...
  const path = pathToFunc("/lobbies/{lobby_id}/members/{user_id}/invites")(
    pathParams,
  );
  ...
  >(
    M.json(
      200,
      operations.CreateLinkedLobbyGuildInviteForUserResponse$inboundSchema,
