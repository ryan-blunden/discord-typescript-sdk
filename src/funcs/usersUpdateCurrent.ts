 ...
 */
export function usersUpdateCurrent(
  client: DiscordCore,
  request: components.BotAccountPatchRequest,
  options?: RequestOptions,
): APIPromise<
  Result<
    operations.UpdateMyUserResponse,
...
> {
  const parsed = safeParse(
    request,
    (value) => components.BotAccountPatchRequest$outboundSchema.parse(value),
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.UpdateMyUserResponse$inboundSchema, {
      hdrs: true,
      key: "Result",
    }),
