 ...
 */
export function webhooksUpdateMessageForm(
  client: DiscordCore,
  request: operations.UpdateWebhookMessageFormRequest,
  options?: RequestOptions,
): APIPromise<
  Result<
    operations.UpdateWebhookMessageFormResponse,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.UpdateWebhookMessageFormRequest$outboundSchema.parse(value),
  ...
  const context = {
    ...
    operationID: "update_webhook_message_form",
    oAuth2Scopes: null,
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.UpdateWebhookMessageFormResponse$inboundSchema, {
      hdrs: true,
      key: "Result",
    }),
