 ...
 */
export function guildsUpdateWelcomeScreen(
  client: DiscordCore,
  request: operations.UpdateGuildWelcomeScreenRequest,
  options?: RequestOptions,
): APIPromise<
  Result<
    operations.UpdateGuildWelcomeScreenResponse,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.UpdateGuildWelcomeScreenRequest$outboundSchema.parse(value),
  ...
  const body = encodeJSON("body", payload.WelcomeScreenPatchRequestPartial, {
    explode: true,
  });
  ...
  const path = pathToFunc("/guilds/{guild_id}/welcome-screen")(pathParams);
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.UpdateGuildWelcomeScreenResponse$inboundSchema, {
      hdrs: true,
      key: "Result",
    }),
