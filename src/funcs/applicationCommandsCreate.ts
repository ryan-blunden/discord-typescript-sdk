 ...
 */
export function applicationCommandsCreate(
  client: DiscordCore,
  ...
  Result<
    operations.CreateApplicationCommandResponse,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.CreateApplicationCommandRequest$outboundSchema.parse(value),
  ...
  >(
    M.json(
      [200, 201],
      operations.CreateApplicationCommandResponse$inboundSchema,
