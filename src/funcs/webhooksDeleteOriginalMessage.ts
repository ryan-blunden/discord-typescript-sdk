 ...
 */
export function webhooksDeleteOriginalMessage(
  client: DiscordCore,
  ...
  Result<
    operations.DeleteOriginalWebhookMessageResponse | undefined,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.DeleteOriginalWebhookMessageRequest$outboundSchema.parse(
        value,
      ),
  ...
  >(
    M.nil(
      204,
      operations.DeleteOriginalWebhookMessageResponse$inboundSchema.optional(),
      { hdrs: true },
    ),
