 ...
 */
export function guildsDeleteRole(
  client: DiscordCore,
  request: operations.DeleteGuildRoleRequest,
  options?: RequestOptions,
): APIPromise<
  Result<
    operations.DeleteGuildRoleResponse | undefined,
...
> {
  const parsed = safeParse(
    request,
    (value) => operations.DeleteGuildRoleRequest$outboundSchema.parse(value),
  ...
  const path = pathToFunc("/guilds/{guild_id}/roles/{role_id}")(pathParams);
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.nil(204, operations.DeleteGuildRoleResponse$inboundSchema.optional(), {
      hdrs: true,
    }),
