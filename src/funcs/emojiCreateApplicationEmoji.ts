 ...
 */
export function emojiCreateApplicationEmoji(
  client: DiscordCore,
  request: operations.CreateApplicationEmojiRequest,
  options?: RequestOptions,
): APIPromise<
  Result<
    operations.CreateApplicationEmojiResponse,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.CreateApplicationEmojiRequest$outboundSchema.parse(value),
  ...
  const path = pathToFunc("/applications/{application_id}/emojis")(pathParams);
  ...
  const [result] = await M.match<
    ...
    | ConnectionError
  >(
    M.json(201, operations.CreateApplicationEmojiResponse$inboundSchema, {
      hdrs: true,
      key: "Result",
    }),
