 ...
 */
export function guildsUpdateWidgetSettings(
  client: DiscordCore,
  request: operations.UpdateGuildWidgetSettingsRequest,
  options?: RequestOptions,
): APIPromise<
  Result<
    operations.UpdateGuildWidgetSettingsResponse,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.UpdateGuildWidgetSettingsRequest$outboundSchema.parse(value),
  ...
  const path = pathToFunc("/guilds/{guild_id}/widget")(pathParams);
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.UpdateGuildWidgetSettingsResponse$inboundSchema, {
      hdrs: true,
      key: "Result",
    }),
