 ...
 */
export function autoModerationDeleteRule(
  client: DiscordCore,
  request: operations.DeleteAutoModerationRuleRequest,
  options?: RequestOptions,
): APIPromise<
  Result<
    operations.DeleteAutoModerationRuleResponse | undefined,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.DeleteAutoModerationRuleRequest$outboundSchema.parse(value),
  ...
  >(
    M.nil(
      204,
      operations.DeleteAutoModerationRuleResponse$inboundSchema.optional(),
      { hdrs: true },
    ),
