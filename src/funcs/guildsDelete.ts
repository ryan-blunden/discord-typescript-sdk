...
export function guildsDelete(
  ...
  Result<
    operations.DeleteGuildResponse | undefined,
...
> {
  const parsed = safeParse(
    request,
    (value) => operations.DeleteGuildRequest$outboundSchema.parse(value),
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.nil(204, operations.DeleteGuildResponse$inboundSchema.optional(), {
      hdrs: true,
    }),
