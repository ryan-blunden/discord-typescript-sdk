 ...
 */
export function guildsUpdateRolePositions(
  client: DiscordCore,
  request: operations.BulkUpdateGuildRolesRequest,
  options?: RequestOptions,
): APIPromise<
  Result<
    operations.BulkUpdateGuildRolesResponse,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.BulkUpdateGuildRolesRequest$outboundSchema.parse(value),
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.BulkUpdateGuildRolesResponse$inboundSchema, {
      hdrs: true,
      key: "Result",
    }),
