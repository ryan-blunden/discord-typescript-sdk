 ...
 */
export function getGuildJoinRequests(
  client: DiscordCore,
  request: operations.GetGuildJoinRequestsRequest,
  options?: RequestOptions,
): APIPromise<
  Result<
    operations.GetGuildJoinRequestsResponse,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.GetGuildJoinRequestsRequest$outboundSchema.parse(value),
  ...
  const path = pathToFunc("/guilds/{guild_id}/requests")(pathParams);
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.GetGuildJoinRequestsResponse$inboundSchema, {
      hdrs: true,
      key: "Result",
    }),
