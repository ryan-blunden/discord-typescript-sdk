 ...
 */
export function applicationCommandsListGuildPermissions(
  client: DiscordCore,
  ...
  Result<
    operations.ListGuildApplicationCommandPermissionsResponse,
...
> {
  ...
  >(
    M.json(
      200,
      operations.ListGuildApplicationCommandPermissionsResponse$inboundSchema,
