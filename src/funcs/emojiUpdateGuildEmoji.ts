 ...
 */
export function emojiUpdateGuildEmoji(
  client: DiscordCore,
  request: operations.UpdateGuildEmojiRequest,
  options?: RequestOptions,
): APIPromise<
  Result<
    operations.UpdateGuildEmojiResponse,
...
> {
  const parsed = safeParse(
    request,
    (value) => operations.UpdateGuildEmojiRequest$outboundSchema.parse(value),
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.UpdateGuildEmojiResponse$inboundSchema, {
      hdrs: true,
      key: "Result",
    }),
