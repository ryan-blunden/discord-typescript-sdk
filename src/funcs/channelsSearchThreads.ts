 ...
 */
export function channelsSearchThreads(
  client: DiscordCore,
  request: operations.ThreadSearchRequest,
  options?: RequestOptions,
): APIPromise<
  Result<
    operations.ThreadSearchResponse,
...
> {
  const parsed = safeParse(
    request,
    (value) => operations.ThreadSearchRequest$outboundSchema.parse(value),
  ...
  const path = pathToFunc("/channels/{channel_id}/threads/search")(pathParams);
  ...
  const query = encodeFormQuery({
    ...
    "tag": payload.tag,
    "tag_setting": payload.tag_setting,
  });
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.ThreadSearchResponse$inboundSchema, {
      hdrs: true,
      key: "Result",
    }),
    M.json(202, operations.ThreadSearchResponse$inboundSchema, {
      hdrs: true,
      key: "Result",
    }),
