 ...
 */
export function webhooksUpdateOriginalMessageJson(
  client: DiscordCore,
  request: operations.UpdateOriginalWebhookMessageJsonRequest,
  options?: RequestOptions,
): APIPromise<
  Result<
    operations.UpdateOriginalWebhookMessageJsonResponse,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.UpdateOriginalWebhookMessageJsonRequest$outboundSchema.parse(
        value,
      ),
  ...
  const context = {
    ...
    operationID: "update_original_webhook_message_json",
    oAuth2Scopes: null,
  ...
  >(
    M.json(
      200,
      operations.UpdateOriginalWebhookMessageJsonResponse$inboundSchema,
