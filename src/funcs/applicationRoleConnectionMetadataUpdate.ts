 ...
 */
export function applicationRoleConnectionMetadataUpdate(
  client: DiscordCore,
  request: operations.UpdateApplicationRoleConnectionsMetadataRequest,
  options?: RequestOptions,
): APIPromise<
  Result<
    operations.UpdateApplicationRoleConnectionsMetadataResponse,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.UpdateApplicationRoleConnectionsMetadataRequest$outboundSchema
        .parse(value),
  ...
  >(
    M.json(
      200,
      operations.UpdateApplicationRoleConnectionsMetadataResponse$inboundSchema,
