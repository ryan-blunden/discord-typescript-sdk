 ...
 */
export function stageInstancesDelete(
  client: DiscordCore,
  request: operations.DeleteStageInstanceRequest,
  options?: RequestOptions,
): APIPromise<
  Result<
    operations.DeleteStageInstanceResponse | undefined,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.DeleteStageInstanceRequest$outboundSchema.parse(value),
  ...
  const path = pathToFunc("/stage-instances/{channel_id}")(pathParams);
  ...
  >(
    M.nil(
      204,
      operations.DeleteStageInstanceResponse$inboundSchema.optional(),
      { hdrs: true },
    ),
