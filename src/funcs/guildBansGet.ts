...
export async function guildBansGet(
  client: DiscordCore,
  request: operations.GetGuildBanRequest,
  options?: RequestOptions,
): Promise<
  Result<
    components.GuildBanResponse,
...
> {
  const parsed = safeParse(
    request,
    (value) => operations.GetGuildBanRequest$outboundSchema.parse(value),
  ...
  const [result] = await M.match<
    ...
    | ConnectionError
  >(
    M.json(200, components.GuildBanResponse$inboundSchema),
