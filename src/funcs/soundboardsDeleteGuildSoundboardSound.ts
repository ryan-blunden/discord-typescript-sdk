 ...
 */
export function soundboardsDeleteGuildSoundboardSound(
  client: DiscordCore,
  request: operations.DeleteGuildSoundboardSoundRequest,
  options?: RequestOptions,
): APIPromise<
  Result<
    operations.DeleteGuildSoundboardSoundResponse | undefined,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.DeleteGuildSoundboardSoundRequest$outboundSchema.parse(value),
  ...
  >(
    M.nil(
      204,
      operations.DeleteGuildSoundboardSoundResponse$inboundSchema.optional(),
      { hdrs: true },
    ),
