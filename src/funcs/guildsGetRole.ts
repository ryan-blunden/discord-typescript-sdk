 ...
 */
export function guildsGetRole(
  client: DiscordCore,
  request: operations.GetGuildRoleRequest,
  options?: RequestOptions,
): APIPromise<
  Result<
    operations.GetGuildRoleResponse,
...
> {
  const parsed = safeParse(
    request,
    (value) => operations.GetGuildRoleRequest$outboundSchema.parse(value),
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.GetGuildRoleResponse$inboundSchema, {
      hdrs: true,
      key: "Result",
    }),
