 ...
 */
export function channelsRemoveGroupDMRecipient(
  client: DiscordCore,
  request: operations.DeleteGroupDmUserRequest,
  options?: RequestOptions,
): APIPromise<
  Result<
    operations.DeleteGroupDmUserResponse | undefined,
...
> {
  const parsed = safeParse(
    request,
    (value) => operations.DeleteGroupDmUserRequest$outboundSchema.parse(value),
  ...
  const [result] = await M.match<
    ...
    | ConnectionError
  >(
    M.nil(204, operations.DeleteGroupDmUserResponse$inboundSchema.optional(), {
      hdrs: true,
    }),
