 ...
 */
export function channelsCreateInviteForm(
  client: DiscordCore,
  request: operations.CreateChannelInviteFormRequest,
  options?: RequestOptions,
): APIPromise<
  Result<
    operations.CreateChannelInviteFormResponse | undefined,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.CreateChannelInviteFormRequest$outboundSchema.parse(value),
  ...
  const context = {
    ...
    operationID: "create_channel_invite_form",
    oAuth2Scopes: null,
  ...
  >(
    M.json(
      200,
      operations.CreateChannelInviteFormResponse$inboundSchema.optional(),
