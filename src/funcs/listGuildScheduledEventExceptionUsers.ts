 ...
 */
export function listGuildScheduledEventExceptionUsers(
  client: DiscordCore,
  request: operations.ListGuildScheduledEventExceptionUsersRequest,
  options?: RequestOptions,
): APIPromise<
  Result<
    operations.ListGuildScheduledEventExceptionUsersResponse,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.ListGuildScheduledEventExceptionUsersRequest$outboundSchema
        .parse(value),
  ...
  const pathParams = {
    ...
    guild_scheduled_event_exception_id: encodeSimple(
      "guild_scheduled_event_exception_id",
      payload.guild_scheduled_event_exception_id,
      { explode: false, charEncoding: "percent" },
    ),
    guild_scheduled_event_id: encodeSimple(
  ...
  const query = encodeFormQuery({
    ...
    "limit": payload.limit,
    "with_member": payload.with_member,
  });
  ...
  >(
    M.json(
      200,
      operations.ListGuildScheduledEventExceptionUsersResponse$inboundSchema,
