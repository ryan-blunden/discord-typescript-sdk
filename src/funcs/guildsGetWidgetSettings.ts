 ...
 */
export function guildsGetWidgetSettings(
  client: DiscordCore,
  request: operations.GetGuildWidgetSettingsRequest,
  options?: RequestOptions,
): APIPromise<
  Result<
    operations.GetGuildWidgetSettingsResponse,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.GetGuildWidgetSettingsRequest$outboundSchema.parse(value),
  ...
  const [result] = await M.match<
    ...
    | ConnectionError
  >(
    M.json(200, operations.GetGuildWidgetSettingsResponse$inboundSchema, {
      hdrs: true,
      key: "Result",
    }),
