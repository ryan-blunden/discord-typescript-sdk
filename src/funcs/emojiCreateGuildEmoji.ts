 ...
 */
export function emojiCreateGuildEmoji(
  client: DiscordCore,
  request: operations.CreateGuildEmojiRequest,
  options?: RequestOptions,
): APIPromise<
  Result<
    operations.CreateGuildEmojiResponse,
...
> {
  const parsed = safeParse(
    request,
    (value) => operations.CreateGuildEmojiRequest$outboundSchema.parse(value),
  ...
  const path = pathToFunc("/guilds/{guild_id}/emojis")(pathParams);
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(201, operations.CreateGuildEmojiResponse$inboundSchema, {
      hdrs: true,
      key: "Result",
    }),
