 ...
 */
export function channelsTriggerTypingIndicator(
  client: DiscordCore,
  request: operations.TriggerTypingIndicatorRequest,
  options?: RequestOptions,
): APIPromise<
  Result<
    components.TypingIndicatorResponse | undefined,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.TriggerTypingIndicatorRequest$outboundSchema.parse(value),
  ...
  const path = pathToFunc("/channels/{channel_id}/typing")(pathParams);
  ...
  const [result] = await M.match<
    ...
    | ConnectionError
  >(
    M.json(200, components.TypingIndicatorResponse$inboundSchema.optional()),
    M.nil(204, components.TypingIndicatorResponse$inboundSchema.optional()),
