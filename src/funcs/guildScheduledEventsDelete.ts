 ...
 */
export function guildScheduledEventsDelete(
  client: DiscordCore,
  request: operations.DeleteGuildScheduledEventRequest,
  options?: RequestOptions,
): APIPromise<
  Result<
    operations.DeleteGuildScheduledEventResponse | undefined,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.DeleteGuildScheduledEventRequest$outboundSchema.parse(value),
  ...
  >(
    M.nil(
      204,
      operations.DeleteGuildScheduledEventResponse$inboundSchema.optional(),
      { hdrs: true },
    ),
