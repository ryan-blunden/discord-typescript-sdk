...
export async function guildsCreateScheduledEvent(
  client: DiscordCore,
  request: operations.CreateGuildScheduledEventRequest,
  options?: RequestOptions,
): Promise<
  Result<
    operations.CreateGuildScheduledEventResponseBody,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.CreateGuildScheduledEventRequest$outboundSchema.parse(value),
  ...
  const [result] = await M.match<
    ...
    | ConnectionError
  >(
    M.json(200, operations.CreateGuildScheduledEventResponseBody$inboundSchema),
