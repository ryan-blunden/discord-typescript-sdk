 ...
 */
export function usersUpdateApplicationRoleConnection(
  client: DiscordCore,
  request: operations.UpdateApplicationUserRoleConnectionRequest,
  options?: RequestOptions,
): APIPromise<
  Result<
    operations.UpdateApplicationUserRoleConnectionResponse,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.UpdateApplicationUserRoleConnectionRequest$outboundSchema
        .parse(value),
  ...
  const body = encodeJSON(
    "body",
    payload.UpdateApplicationUserRoleConnectionRequest,
    { explode: true },
  );
  ...
  const context = {
    ...
    oAuth2Scopes: ["role_connections.write"],
  ...
  >(
    M.json(
      200,
      operations.UpdateApplicationUserRoleConnectionResponse$inboundSchema,
