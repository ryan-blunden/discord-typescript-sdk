 ...
 */
export function messagesCreateReaction(
  client: DiscordCore,
  request: operations.AddMyMessageReactionRequest,
  options?: RequestOptions,
): APIPromise<
  Result<
    operations.AddMyMessageReactionResponse | undefined,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.AddMyMessageReactionRequest$outboundSchema.parse(value),
  ...
  >(
    M.nil(
      204,
      operations.AddMyMessageReactionResponse$inboundSchema.optional(),
      { hdrs: true },
    ),
