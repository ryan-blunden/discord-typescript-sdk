 ...
 */
export function guildsGetVanityUrl(
  client: DiscordCore,
  request: operations.GetGuildVanityUrlRequest,
  options?: RequestOptions,
): APIPromise<
  Result<
    operations.GetGuildVanityUrlResponse,
...
> {
  const parsed = safeParse(
    request,
    (value) => operations.GetGuildVanityUrlRequest$outboundSchema.parse(value),
  ...
  const path = pathToFunc("/guilds/{guild_id}/vanity-url")(pathParams);
  ...
  const [result] = await M.match<
    ...
    | ConnectionError
  >(
    M.json(200, operations.GetGuildVanityUrlResponse$inboundSchema, {
      hdrs: true,
      key: "Result",
    }),
