 ...
 */
export function webhooksExecute(
  client: DiscordCore,
  request: operations.ExecuteWebhookRequest,
  options?: RequestOptions,
): APIPromise<
  Result<
    operations.ExecuteWebhookResponse | undefined,
...
> {
  const parsed = safeParse(
    request,
    (value) => operations.ExecuteWebhookRequest$outboundSchema.parse(value),
  ...
  const path = pathToFunc("/webhooks/{webhook_id}/{webhook_token}")(pathParams);
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.ExecuteWebhookResponse$inboundSchema.optional(), {
      hdrs: true,
      key: "Result",
    }),
    M.nil(204, operations.ExecuteWebhookResponse$inboundSchema.optional(), {
      hdrs: true,
    }),
