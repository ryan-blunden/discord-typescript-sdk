 ...
 */
export function emojiGetGuildEmoji(
  client: DiscordCore,
  request: operations.GetGuildEmojiRequest,
  options?: RequestOptions,
): APIPromise<
  Result<
    operations.GetGuildEmojiResponse,
...
> {
  const parsed = safeParse(
    request,
    (value) => operations.GetGuildEmojiRequest$outboundSchema.parse(value),
  ...
  const [result] = await M.match<
    ...
    | ConnectionError
  >(
    M.json(200, operations.GetGuildEmojiResponse$inboundSchema, {
      hdrs: true,
      key: "Result",
    }),
