...
export function webhooksUpdateOriginalMessageMultipart(
  ...
  Result<
    operations.UpdateOriginalWebhookMessageMultipartResponse,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.UpdateOriginalWebhookMessageMultipartRequest$outboundSchema
        .parse(value),
  ...
  const context = {
    ...
    operationID: "update_original_webhook_message_multipart",
    oAuth2Scopes: null,
  ...
  >(
    M.json(
      200,
      operations.UpdateOriginalWebhookMessageMultipartResponse$inboundSchema,
