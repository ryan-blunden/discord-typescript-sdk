...
export async function stageInstancesUpdate(
  client: DiscordCore,
  request: operations.UpdateStageInstanceRequest,
  options?: RequestOptions,
): Promise<
  Result<
    components.StageInstanceResponse,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.UpdateStageInstanceRequest$outboundSchema.parse(value),
  ...
  const [result] = await M.match<
    ...
    | ConnectionError
  >(
    M.json(200, components.StageInstanceResponse$inboundSchema),
