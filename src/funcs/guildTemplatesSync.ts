 ...
 */
export function guildTemplatesSync(
  client: DiscordCore,
  request: operations.SyncGuildTemplateRequest,
  options?: RequestOptions,
): APIPromise<
  Result<
    operations.SyncGuildTemplateResponse,
...
> {
  const parsed = safeParse(
    request,
    (value) => operations.SyncGuildTemplateRequest$outboundSchema.parse(value),
  ...
  const [result] = await M.match<
    ...
    | ConnectionError
  >(
    M.json(200, operations.SyncGuildTemplateResponse$inboundSchema, {
      hdrs: true,
      key: "Result",
    }),
