 ...
 */
export function webhooksDeleteMessage(
  client: DiscordCore,
  ...
  Result<
    operations.DeleteWebhookMessageResponse | undefined,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.DeleteWebhookMessageRequest$outboundSchema.parse(value),
  ...
  >(
    M.nil(
      204,
      operations.DeleteWebhookMessageResponse$inboundSchema.optional(),
      { hdrs: true },
    ),
