...
export async function channelsGet(
  client: DiscordCore,
  request: operations.GetChannelRequest,
  options?: RequestOptions,
): Promise<
  Result<
    operations.GetChannelResponseBody,
...
> {
  const parsed = safeParse(
    request,
    (value) => operations.GetChannelRequest$outboundSchema.parse(value),
  ...
  const [result] = await M.match<
    ...
    | ConnectionError
  >(
    M.json(200, operations.GetChannelResponseBody$inboundSchema),
