 ...
 */
export function applicationRoleConnectionMetadataList(
  client: DiscordCore,
  request: operations.GetApplicationRoleConnectionsMetadataRequest,
  options?: RequestOptions,
): APIPromise<
  Result<
    operations.GetApplicationRoleConnectionsMetadataResponse,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.GetApplicationRoleConnectionsMetadataRequest$outboundSchema
        .parse(value),
  ...
  >(
    M.json(
      200,
      operations.GetApplicationRoleConnectionsMetadataResponse$inboundSchema,
