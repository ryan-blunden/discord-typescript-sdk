 ...
 */
export function channelsAddGroupDMRecipient(
  client: DiscordCore,
  request: operations.AddGroupDmUserRequest,
  options?: RequestOptions,
): APIPromise<
  Result<
    operations.AddGroupDmUserResponse | undefined,
...
> {
  ...
  const [result] = await M.match<
    ...
    | ConnectionError
  >(
    M.json(201, operations.AddGroupDmUserResponse$inboundSchema.optional(), {
      hdrs: true,
      key: "Result",
    }),
    M.nil(204, operations.AddGroupDmUserResponse$inboundSchema.optional(), {
      hdrs: true,
    }),
