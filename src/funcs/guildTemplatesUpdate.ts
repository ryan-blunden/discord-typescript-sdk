 ...
 */
export function guildTemplatesUpdate(
  client: DiscordCore,
  request: operations.UpdateGuildTemplateRequest,
  options?: RequestOptions,
): APIPromise<
  Result<
    operations.UpdateGuildTemplateResponse,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.UpdateGuildTemplateRequest$outboundSchema.parse(value),
  ...
  const path = pathToFunc("/guilds/{guild_id}/templates/{code}")(pathParams);
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.UpdateGuildTemplateResponse$inboundSchema, {
      hdrs: true,
      key: "Result",
    }),
