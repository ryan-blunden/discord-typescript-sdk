 ...
 */
export function applicationCommandsListGuild(
  client: DiscordCore,
  ...
  Result<
    operations.ListGuildApplicationCommandsResponse,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.ListGuildApplicationCommandsRequest$outboundSchema.parse(
        value,
      ),
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.ListGuildApplicationCommandsResponse$inboundSchema, {
      hdrs: true,
      key: "Result",
    }),
