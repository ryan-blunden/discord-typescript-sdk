 ...
 */
export function applicationCommandsDelete(
  client: DiscordCore,
  ...
  Result<
    operations.DeleteApplicationCommandResponse | undefined,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.DeleteApplicationCommandRequest$outboundSchema.parse(value),
  ...
  >(
    M.nil(
      204,
      operations.DeleteApplicationCommandResponse$inboundSchema.optional(),
      { hdrs: true },
    ),
