 ...
 */
export function guildsUpdateIncidentActions(
  client: DiscordCore,
  request: operations.UpdateGuildIncidentActionsRequest,
  options?: RequestOptions,
): APIPromise<
  Result<
    operations.UpdateGuildIncidentActionsResponse,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.UpdateGuildIncidentActionsRequest$outboundSchema.parse(value),
  ...
  const body = encodeJSON("body", payload.GuildIncidentActionsRequest, {
    explode: true,
  });
  ...
  const path = pathToFunc("/guilds/{guild_id}/incident-actions")(pathParams);
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.UpdateGuildIncidentActionsResponse$inboundSchema, {
      hdrs: true,
      key: "Result",
    }),
