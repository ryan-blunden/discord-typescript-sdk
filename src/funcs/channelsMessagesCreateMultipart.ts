...
export async function channelsMessagesCreateMultipart(
  client: DiscordCore,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.CreateMessageMultipartRequest$outboundSchema.parse(value),
  ...
  const context = {
    operationID: "create_message_multipart",
    oAuth2Scopes: [],
