 ...
 */
export function guildsListActiveThreads(
  client: DiscordCore,
  request: operations.GetActiveGuildThreadsRequest,
  options?: RequestOptions,
): APIPromise<
  Result<
    operations.GetActiveGuildThreadsResponse,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.GetActiveGuildThreadsRequest$outboundSchema.parse(value),
  ...
  const path = pathToFunc("/guilds/{guild_id}/threads/active")(pathParams);
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.GetActiveGuildThreadsResponse$inboundSchema, {
      hdrs: true,
      key: "Result",
    }),
