 ...
 */
export function channelsPinMessage(
  client: DiscordCore,
  request: operations.DeprecatedCreatePinRequest,
  options?: RequestOptions,
): APIPromise<
  Result<
    operations.DeprecatedCreatePinResponse | undefined,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.DeprecatedCreatePinRequest$outboundSchema.parse(value),
  ...
  >(
    M.nil(
      204,
      operations.DeprecatedCreatePinResponse$inboundSchema.optional(),
      { hdrs: true },
    ),
