 ...
 */
export function webhooksGetOriginalMessage(
  client: DiscordCore,
  ...
  Result<
    operations.GetOriginalWebhookMessageResponse,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.GetOriginalWebhookMessageRequest$outboundSchema.parse(value),
  ...
  const [result] = await M.match<
    ...
    | ConnectionError
  >(
    M.json(200, operations.GetOriginalWebhookMessageResponse$inboundSchema, {
      hdrs: true,
      key: "Result",
    }),
