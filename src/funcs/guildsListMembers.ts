...
export async function guildsListMembers(
  client: DiscordCore,
...
> {
  const parsed = safeParse(
    request,
    (value) => operations.ListGuildMembersRequest$outboundSchema.parse(value),
  ...
  const path = pathToFunc("/guilds/{guild_id}/members")(pathParams);
