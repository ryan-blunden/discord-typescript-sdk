 ...
 */
export function lobbiesRemoveMember(
  client: DiscordCore,
  request: operations.DeleteLobbyMemberRequest,
  options?: RequestOptions,
): APIPromise<
  Result<
    operations.DeleteLobbyMemberResponse | undefined,
...
> {
  const parsed = safeParse(
    request,
    (value) => operations.DeleteLobbyMemberRequest$outboundSchema.parse(value),
  ...
  const path = pathToFunc("/lobbies/{lobby_id}/members/{user_id}")(pathParams);
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.nil(204, operations.DeleteLobbyMemberResponse$inboundSchema.optional(), {
      hdrs: true,
    }),
