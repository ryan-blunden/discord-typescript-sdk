 ...
 */
export function updateInviteTargetUsers(
  client: DiscordCore,
  request: operations.UpdateInviteTargetUsersRequest,
  options?: RequestOptions,
): APIPromise<
  Result<
    operations.UpdateInviteTargetUsersResponse | undefined,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.UpdateInviteTargetUsersRequest$outboundSchema.parse(value),
  ...
  appendForm(body, "target_users_file", payload.RequestBody.target_users_file);
  ...
  const path = pathToFunc("/invites/{code}/target-users")(pathParams);
  ...
  >(
    M.nil(
      204,
      operations.UpdateInviteTargetUsersResponse$inboundSchema.optional(),
      { hdrs: true },
    ),
