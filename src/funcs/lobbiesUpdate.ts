 ...
 */
export function lobbiesUpdate(
  client: DiscordCore,
  request: operations.EditLobbyRequest,
  options?: RequestOptions,
): APIPromise<
  Result<
    operations.EditLobbyResponse,
...
> {
  const parsed = safeParse(
    request,
    (value) => operations.EditLobbyRequest$outboundSchema.parse(value),
  ...
  const [result] = await M.match<
    ...
    | ConnectionError
  >(
    M.json(200, operations.EditLobbyResponse$inboundSchema, {
      hdrs: true,
      key: "Result",
    }),
