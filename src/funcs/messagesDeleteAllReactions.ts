 ...
 */
export function messagesDeleteAllReactions(
  client: DiscordCore,
  request: operations.DeleteAllMessageReactionsRequest,
  options?: RequestOptions,
): APIPromise<
  Result<
    operations.DeleteAllMessageReactionsResponse | undefined,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.DeleteAllMessageReactionsRequest$outboundSchema.parse(value),
  ...
  >(
    M.nil(
      204,
      operations.DeleteAllMessageReactionsResponse$inboundSchema.optional(),
      { hdrs: true },
    ),
