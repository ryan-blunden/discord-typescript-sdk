 ...
 */
export function webhooksDeleteWithToken(
  client: DiscordCore,
  request: operations.DeleteWebhookByTokenRequest,
  options?: RequestOptions,
): APIPromise<
  Result<
    operations.DeleteWebhookByTokenResponse | undefined,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.DeleteWebhookByTokenRequest$outboundSchema.parse(value),
  ...
  >(
    M.nil(
      204,
      operations.DeleteWebhookByTokenResponse$inboundSchema.optional(),
      { hdrs: true },
    ),
