 ...
 */
export function updateLobbyMessageExternalModerationMetadata(
  client: DiscordCore,
...
async function $do(
  ...
  [
    Result<
      | operations.UpdateLobbyMessageExternalModerationMetadataResponse
      | undefined,
      | errors.RatelimitedResponse
      | errors.ErrorResponse
      | DiscordError
...
> {
  const parsed = safeParse(
    ...
    (value) =>
      operations
        .UpdateLobbyMessageExternalModerationMetadataRequest$outboundSchema
        .parse(value),
  ...
  >(
    M.nil(
      204,
      operations
        .UpdateLobbyMessageExternalModerationMetadataResponse$inboundSchema
        .optional(),
      { hdrs: true },
    ),
