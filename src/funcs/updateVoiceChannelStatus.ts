 ...
 */
export function updateVoiceChannelStatus(
  client: DiscordCore,
  request: operations.UpdateVoiceChannelStatusRequest,
  options?: RequestOptions,
): APIPromise<
  Result<
    operations.UpdateVoiceChannelStatusResponse | undefined,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.UpdateVoiceChannelStatusRequest$outboundSchema.parse(value),
  ...
  const path = pathToFunc("/channels/{channel_id}/voice-status")(pathParams);
  ...
  >(
    M.nil(
      204,
      operations.UpdateVoiceChannelStatusResponse$inboundSchema.optional(),
      { hdrs: true },
    ),
