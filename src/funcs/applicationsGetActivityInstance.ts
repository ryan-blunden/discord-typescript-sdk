 ...
 */
export function applicationsGetActivityInstance(
  client: DiscordCore,
  request: operations.ApplicationsGetActivityInstanceRequest,
  options?: RequestOptions,
): APIPromise<
  Result<
    operations.ApplicationsGetActivityInstanceResponse,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.ApplicationsGetActivityInstanceRequest$outboundSchema.parse(
        value,
      ),
  ...
  >(
    M.json(
      200,
      operations.ApplicationsGetActivityInstanceResponse$inboundSchema,
