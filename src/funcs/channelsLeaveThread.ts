 ...
 */
export function channelsLeaveThread(
  client: DiscordCore,
  request: operations.LeaveThreadRequest,
  options?: RequestOptions,
): APIPromise<
  Result<
    operations.LeaveThreadResponse | undefined,
...
> {
  const parsed = safeParse(
    request,
    (value) => operations.LeaveThreadRequest$outboundSchema.parse(value),
  ...
  const path = pathToFunc("/channels/{channel_id}/thread-members/@me")(
    pathParams,
  );
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.nil(204, operations.LeaveThreadResponse$inboundSchema.optional(), {
      hdrs: true,
    }),
