 ...
 */
export function applicationCommandsBulkSetGuild(
  client: DiscordCore,
  ...
  Result<
    operations.BulkSetGuildApplicationCommandsResponse,
...
> {
  ...
  >(
    M.json(
      200,
      operations.BulkSetGuildApplicationCommandsResponse$inboundSchema,
