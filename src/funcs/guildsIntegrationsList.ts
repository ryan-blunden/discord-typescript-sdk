...
export async function guildsIntegrationsList(
  client: DiscordCore,
  request: operations.ListGuildIntegrationsRequest,
  options?: RequestOptions,
): Promise<
  Result<
    Array<operations.ListGuildIntegrationsResponseBody>,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.ListGuildIntegrationsRequest$outboundSchema.parse(value),
  ...
  const path = pathToFunc("/guilds/{guild_id}/integrations")(pathParams);
  ...
  >(
    M.json(
      200,
      z.array(operations.ListGuildIntegrationsResponseBody$inboundSchema),
    ),
