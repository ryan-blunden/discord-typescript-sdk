 ...
 */
export function messagesCrosspost(
  client: DiscordCore,
  request: operations.CrosspostMessageRequest,
  options?: RequestOptions,
): APIPromise<
  Result<
    operations.CrosspostMessageResponse,
...
> {
  const parsed = safeParse(
    request,
    (value) => operations.CrosspostMessageRequest$outboundSchema.parse(value),
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.CrosspostMessageResponse$inboundSchema, {
      hdrs: true,
      key: "Result",
    }),
