 ...
 */
export function autoModerationCreateRule(
  client: DiscordCore,
  request: operations.CreateAutoModerationRuleRequest,
  options?: RequestOptions,
): APIPromise<
  Result<
    operations.CreateAutoModerationRuleResponse,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.CreateAutoModerationRuleRequest$outboundSchema.parse(value),
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.CreateAutoModerationRuleResponse$inboundSchema, {
      hdrs: true,
      key: "Result",
    }),
