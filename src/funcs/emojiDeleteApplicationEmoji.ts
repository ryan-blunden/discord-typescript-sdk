 ...
 */
export function emojiDeleteApplicationEmoji(
  client: DiscordCore,
  request: operations.DeleteApplicationEmojiRequest,
  options?: RequestOptions,
): APIPromise<
  Result<
    operations.DeleteApplicationEmojiResponse | undefined,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.DeleteApplicationEmojiRequest$outboundSchema.parse(value),
  ...
  const pathParams = {
    ...
    emoji_id: encodeSimple("emoji_id", payload.emoji_id, {
      explode: false,
      charEncoding: "percent",
    }),
  };

  const path = pathToFunc("/applications/{application_id}/emojis/{emoji_id}")(
    pathParams,
  );
  ...
  >(
    M.nil(
      204,
      operations.DeleteApplicationEmojiResponse$inboundSchema.optional(),
      { hdrs: true },
    ),
