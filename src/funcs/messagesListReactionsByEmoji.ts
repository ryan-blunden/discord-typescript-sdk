...
export function messagesListReactionsByEmoji(
  ...
  Result<
    operations.ListMessageReactionsByEmojiResponse,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.ListMessageReactionsByEmojiRequest$outboundSchema.parse(value),
  ...
  const [result] = await M.match<
    ...
    | ConnectionError
  >(
    M.json(200, operations.ListMessageReactionsByEmojiResponse$inboundSchema, {
      hdrs: true,
      key: "Result",
    }),
