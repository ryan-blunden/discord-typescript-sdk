...
export function deleteLobby(
  ...
  Result<
    operations.DeleteLobbyResponse | undefined,
...
> {
  const parsed = safeParse(
    request,
    (value) => operations.DeleteLobbyRequest$outboundSchema.parse(value),
  ...
  const path = pathToFunc("/lobbies/{lobby_id}")(pathParams);
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.nil(204, operations.DeleteLobbyResponse$inboundSchema.optional(), {
      hdrs: true,
    }),
