 ...
 */
export function applicationsPartnerSDKUnmergeProvisionalAccount(
  client: DiscordCore,
  request: operations.PartnerSDKUnmergeProvisionalAccountRequestBody,
  security?: operations.PartnerSDKUnmergeProvisionalAccountSecurity | undefined,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.PartnerSDKUnmergeProvisionalAccountRequestBody$outboundSchema
        .parse(value),
  ...
  const path = pathToFunc("/partner-sdk/provisional-accounts/unmerge")();
  ...
  >(
    M.nil(
      204,
      operations.PartnerSDKUnmergeProvisionalAccountResponse$inboundSchema
        .optional(),
      { hdrs: true },
    ),
