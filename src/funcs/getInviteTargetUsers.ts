 ...
 */
export function getInviteTargetUsers(
  client: DiscordCore,
  request: operations.GetInviteTargetUsersRequest,
  options?: RequestOptions,
): APIPromise<
  Result<
    operations.GetInviteTargetUsersResponse,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.GetInviteTargetUsersRequest$outboundSchema.parse(value),
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.text(200, operations.GetInviteTargetUsersResponse$inboundSchema, {
      ctype: "text/csv",
      hdrs: true,
      key: "Result",
    }),
