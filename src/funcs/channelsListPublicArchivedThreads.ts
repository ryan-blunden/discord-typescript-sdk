 ...
 */
export function channelsListPublicArchivedThreads(
  client: DiscordCore,
  request: operations.ListPublicArchivedThreadsRequest,
  options?: RequestOptions,
): APIPromise<
  Result<
    operations.ListPublicArchivedThreadsResponse,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.ListPublicArchivedThreadsRequest$outboundSchema.parse(value),
  ...
  const path = pathToFunc("/channels/{channel_id}/threads/archived/public")(
    pathParams,
  );
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.ListPublicArchivedThreadsResponse$inboundSchema, {
      hdrs: true,
      key: "Result",
    }),
