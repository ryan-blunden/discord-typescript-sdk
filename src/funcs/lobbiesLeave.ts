...
export function lobbiesLeave(
  ...
  Result<
    operations.LeaveLobbyResponse | undefined,
...
> {
  const parsed = safeParse(
    request,
    (value) => operations.LeaveLobbyRequest$outboundSchema.parse(value),
  ...
  const path = pathToFunc("/lobbies/{lobby_id}/members/@me")(pathParams);
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.nil(204, operations.LeaveLobbyResponse$inboundSchema.optional(), {
      hdrs: true,
    }),
