...
export async function guildsGetAuditLogEntries(
  client: DiscordCore,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.ListGuildAuditLogEntriesRequest$outboundSchema.parse(value),
  ...
  const path = pathToFunc("/guilds/{guild_id}/audit-logs")(pathParams);
