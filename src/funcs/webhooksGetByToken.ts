...
export async function webhooksGetByToken(
  client: DiscordCore,
  ...
  Result<
    operations.GetWebhookByTokenResponseBody,
...
> {
  const parsed = safeParse(
    request,
    (value) => operations.GetWebhookByTokenRequest$outboundSchema.parse(value),
  ...
  const [result] = await M.match<
    ...
    | ConnectionError
  >(
    M.json(200, operations.GetWebhookByTokenResponseBody$inboundSchema),
