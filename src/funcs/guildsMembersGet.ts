...
export async function guildsMembersGet(
  client: DiscordCore,
  request: operations.GetGuildMemberRequest,
  options?: RequestOptions,
): Promise<
  Result<
    components.GuildMemberResponse,
...
> {
  const parsed = safeParse(
    request,
    (value) => operations.GetGuildMemberRequest$outboundSchema.parse(value),
  ...
  const [result] = await M.match<
    ...
    | ConnectionError
  >(
    M.json(200, components.GuildMemberResponse$inboundSchema),
