 ...
 */
export function applicationCommandsGet(
  client: DiscordCore,
  ...
  Result<
    operations.GetApplicationCommandResponse,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.GetApplicationCommandRequest$outboundSchema.parse(value),
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.GetApplicationCommandResponse$inboundSchema, {
      hdrs: true,
      key: "Result",
    }),
