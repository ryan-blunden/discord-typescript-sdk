 ...
 */
export function guildsGetWidget(
  client: DiscordCore,
  ...
  Result<
    operations.GetGuildWidgetResponse,
...
> {
  const parsed = safeParse(
    request,
    (value) => operations.GetGuildWidgetRequest$outboundSchema.parse(value),
  ...
  const path = pathToFunc("/guilds/{guild_id}/widget.json")(pathParams);
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.GetGuildWidgetResponse$inboundSchema, {
      hdrs: true,
      key: "Result",
    }),
