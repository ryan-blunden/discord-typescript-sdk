...
export function createPin(
  ...
  Result<
    operations.CreatePinResponse | undefined,
...
> {
  const parsed = safeParse(
    request,
    (value) => operations.CreatePinRequest$outboundSchema.parse(value),
  ...
  const path = pathToFunc("/channels/{channel_id}/messages/pins/{message_id}")(
    pathParams,
  );
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.nil(204, operations.CreatePinResponse$inboundSchema.optional(), {
      hdrs: true,
    }),
