...
export function webhooksDelete(
  ...
  Result<
    operations.DeleteWebhookResponse | undefined,
...
> {
  ...
  const path = pathToFunc("/webhooks/{webhook_id}")(pathParams);
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.nil(204, operations.DeleteWebhookResponse$inboundSchema.optional(), {
      hdrs: true,
    }),
