...
export function createInteractionResponse(
  ...
  Result<
    operations.CreateInteractionResponseResponse | undefined,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.CreateInteractionResponseRequest$outboundSchema.parse(value),
  ...
  const pathParams = {
    interaction_id: encodeSimple("interaction_id", payload.interaction_id, {
      explode: false,
      charEncoding: "percent",
    }),
    interaction_token: encodeSimple(
      "interaction_token",
  ...
  const query = encodeFormQuery({
    "with_response": payload.with_response,
  });
  ...
  >(
    M.json(
      200,
      operations.CreateInteractionResponseResponse$inboundSchema.optional(),
