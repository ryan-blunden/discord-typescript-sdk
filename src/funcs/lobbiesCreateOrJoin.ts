 ...
 */
export function lobbiesCreateOrJoin(
  client: DiscordCore,
  ...
  Result<
    operations.CreateOrJoinLobbyResponse,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.CreateOrJoinLobbyRequestBody$outboundSchema.parse(value),
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.CreateOrJoinLobbyResponse$inboundSchema, {
      hdrs: true,
      key: "Result",
    }),
