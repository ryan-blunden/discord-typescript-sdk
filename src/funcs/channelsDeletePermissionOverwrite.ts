 ...
 */
export function channelsDeletePermissionOverwrite(
  client: DiscordCore,
  request: operations.DeleteChannelPermissionOverwriteRequest,
  options?: RequestOptions,
): APIPromise<
  Result<
    operations.DeleteChannelPermissionOverwriteResponse | undefined,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.DeleteChannelPermissionOverwriteRequest$outboundSchema.parse(
        value,
      ),
  ...
  const pathParams = {
    ...
    overwrite_id: encodeSimple("overwrite_id", payload.overwrite_id, {
      explode: false,
      charEncoding: "percent",
    }),
  };

  const path = pathToFunc("/channels/{channel_id}/permissions/{overwrite_id}")(
    pathParams,
  );
  ...
  >(
    M.nil(
      204,
      operations.DeleteChannelPermissionOverwriteResponse$inboundSchema
        .optional(),
      { hdrs: true },
    ),
