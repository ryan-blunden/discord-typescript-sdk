 ...
 */
export function guildsCreateBan(
  client: DiscordCore,
  request: operations.BanUserFromGuildRequest,
  options?: RequestOptions,
): APIPromise<
  Result<
    operations.BanUserFromGuildResponse | undefined,
...
> {
  const parsed = safeParse(
    request,
    (value) => operations.BanUserFromGuildRequest$outboundSchema.parse(value),
  ...
  const body = encodeJSON("body", payload.BanUserFromGuildRequest, {
    explode: true,
  });
  ...
  const [result] = await M.match<
    ...
    | ConnectionError
  >(
    M.nil(204, operations.BanUserFromGuildResponse$inboundSchema.optional(), {
      hdrs: true,
    }),
