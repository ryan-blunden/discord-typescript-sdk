 ...
 */
export function messagesDeleteOwnReaction(
  client: DiscordCore,
  request: operations.DeleteMyMessageReactionRequest,
  options?: RequestOptions,
): APIPromise<
  Result<
    operations.DeleteMyMessageReactionResponse | undefined,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.DeleteMyMessageReactionRequest$outboundSchema.parse(value),
  ...
  >(
    M.nil(
      204,
      operations.DeleteMyMessageReactionResponse$inboundSchema.optional(),
      { hdrs: true },
    ),
