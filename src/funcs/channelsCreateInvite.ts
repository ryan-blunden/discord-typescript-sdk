...
export async function channelsCreateInvite(
  client: DiscordCore,
  request: operations.CreateChannelInviteRequest,
  options?: RequestOptions,
): Promise<
  Result<
    operations.CreateChannelInviteResponseBody | undefined,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.CreateChannelInviteRequest$outboundSchema.parse(value),
  ...
  >(
    M.json(
      200,
      operations.CreateChannelInviteResponseBody$inboundSchema.optional(),
    ),
    M.nil(
      204,
      operations.CreateChannelInviteResponseBody$inboundSchema.optional(),
