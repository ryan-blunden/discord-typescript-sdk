 ...
 */
export function voiceUpdateCurrentUserState(
  client: DiscordCore,
  request: operations.UpdateSelfVoiceStateRequest,
  options?: RequestOptions,
): APIPromise<
  Result<
    operations.UpdateSelfVoiceStateResponse | undefined,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.UpdateSelfVoiceStateRequest$outboundSchema.parse(value),
  ...
  const body = encodeJSON("body", payload.UpdateSelfVoiceStateRequestPartial, {
    explode: true,
  });
  ...
  const path = pathToFunc("/guilds/{guild_id}/voice-states/@me")(pathParams);
  ...
  >(
    M.nil(
      204,
      operations.UpdateSelfVoiceStateResponse$inboundSchema.optional(),
      { hdrs: true },
    ),
