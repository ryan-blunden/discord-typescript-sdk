 ...
 */
export function applicationCommandsCreateGuild(
  client: DiscordCore,
  ...
  Result<
    operations.CreateGuildApplicationCommandResponse,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.CreateGuildApplicationCommandRequest$outboundSchema.parse(
        value,
      ),
  ...
  >(
    M.json(
      [200, 201],
      operations.CreateGuildApplicationCommandResponse$inboundSchema,
