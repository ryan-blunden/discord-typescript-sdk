 ...
 */
export function stickersListGuildStickers(
  client: DiscordCore,
  request: operations.ListGuildStickersRequest,
  options?: RequestOptions,
): APIPromise<
  Result<
    Array<components.GuildStickerResponse>,
...
> {
  const parsed = safeParse(
    request,
    (value) => operations.ListGuildStickersRequest$outboundSchema.parse(value),
  ...
  const [result] = await M.match<
    ...
    | ConnectionError
  >(
    M.json(200, z.array(components.GuildStickerResponse$inboundSchema)),
