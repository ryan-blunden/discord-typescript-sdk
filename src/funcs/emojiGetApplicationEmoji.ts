 ...
 */
export function emojiGetApplicationEmoji(
  client: DiscordCore,
  request: operations.GetApplicationEmojiRequest,
  options?: RequestOptions,
): APIPromise<
  Result<
    operations.GetApplicationEmojiResponse,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.GetApplicationEmojiRequest$outboundSchema.parse(value),
  ...
  const [result] = await M.match<
    ...
    | ConnectionError
  >(
    M.json(200, operations.GetApplicationEmojiResponse$inboundSchema, {
      hdrs: true,
      key: "Result",
    }),
