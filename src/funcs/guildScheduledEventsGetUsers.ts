 ...
 */
export function guildScheduledEventsGetUsers(
  client: DiscordCore,
  request: operations.ListGuildScheduledEventUsersRequest,
  options?: RequestOptions,
): APIPromise<
  Result<
    operations.ListGuildScheduledEventUsersResponse,
...
> {
  ...
  const [result] = await M.match<
    ...
    | ConnectionError
  >(
    M.json(200, operations.ListGuildScheduledEventUsersResponse$inboundSchema, {
      hdrs: true,
      key: "Result",
    }),
