 ...
 */
export function applicationCommandsUpdate(
  client: DiscordCore,
  ...
  Result<
    operations.UpdateApplicationCommandResponse,
...
> {
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.UpdateApplicationCommandResponse$inboundSchema, {
      hdrs: true,
      key: "Result",
    }),
