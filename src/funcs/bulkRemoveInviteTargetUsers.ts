 ...
 */
export function bulkRemoveInviteTargetUsers(
  client: DiscordCore,
  request: operations.BulkRemoveInviteTargetUsersRequest,
  options?: RequestOptions,
): APIPromise<
  Result<
    operations.BulkRemoveInviteTargetUsersResponse | undefined,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.BulkRemoveInviteTargetUsersRequest$outboundSchema.parse(value),
  ...
  const path = pathToFunc("/invites/{code}/target-users/bulk-delete")(
    pathParams,
  );
  ...
  >(
    M.nil(
      204,
      operations.BulkRemoveInviteTargetUsersResponse$inboundSchema.optional(),
      { hdrs: true },
    ),
