...
export async function webhooksUpdateByToken(
  client: DiscordCore,
  ...
  Result<
    operations.UpdateWebhookByTokenResponseBody,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.UpdateWebhookByTokenRequest$outboundSchema.parse(value),
  ...
  const [result] = await M.match<
    ...
    | ConnectionError
  >(
    M.json(200, operations.UpdateWebhookByTokenResponseBody$inboundSchema),
