 ...
 */
export function emojiListGuildEmojis(
  client: DiscordCore,
  request: operations.ListGuildEmojisRequest,
  options?: RequestOptions,
): APIPromise<
  Result<
    operations.ListGuildEmojisResponse,
...
> {
  const parsed = safeParse(
    request,
    (value) => operations.ListGuildEmojisRequest$outboundSchema.parse(value),
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.ListGuildEmojisResponse$inboundSchema, {
      hdrs: true,
      key: "Result",
    }),
