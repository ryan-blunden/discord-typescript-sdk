 ...
 */
export function applicationCommandsUpdateGuild(
  client: DiscordCore,
  ...
  Result<
    operations.UpdateGuildApplicationCommandResponse,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.UpdateGuildApplicationCommandRequest$outboundSchema.parse(
        value,
      ),
  ...
  >(
    M.json(
      200,
      operations.UpdateGuildApplicationCommandResponse$inboundSchema,
