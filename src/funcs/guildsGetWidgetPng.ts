...
export function guildsGetWidgetPng(
  ...
  Result<
    operations.GetGuildWidgetPngResponse,
...
> {
  ...
  const path = pathToFunc("/guilds/{guild_id}/widget.png")(pathParams);
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.text(200, operations.GetGuildWidgetPngResponse$inboundSchema, {
      ctype: "image/png",
      hdrs: true,
      key: "Result",
    }),
