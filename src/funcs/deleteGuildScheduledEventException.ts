 ...
 */
export function deleteGuildScheduledEventException(
  client: DiscordCore,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.DeleteGuildScheduledEventExceptionRequest$outboundSchema.parse(
        value,
      ),
  ...
  >(
    M.nil(
      204,
      operations.DeleteGuildScheduledEventExceptionResponse$inboundSchema
        .optional(),
      { hdrs: true },
    ),
