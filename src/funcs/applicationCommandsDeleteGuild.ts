 ...
 */
export function applicationCommandsDeleteGuild(
  client: DiscordCore,
  ...
  Result<
    operations.DeleteGuildApplicationCommandResponse | undefined,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.DeleteGuildApplicationCommandRequest$outboundSchema.parse(
        value,
      ),
  ...
  >(
    M.nil(
      204,
      operations.DeleteGuildApplicationCommandResponse$inboundSchema.optional(),
      { hdrs: true },
    ),
