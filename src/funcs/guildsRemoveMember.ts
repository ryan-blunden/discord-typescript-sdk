 ...
 */
export function guildsRemoveMember(
  client: DiscordCore,
  request: operations.DeleteGuildMemberRequest,
  options?: RequestOptions,
): APIPromise<
  Result<
    operations.DeleteGuildMemberResponse | undefined,
...
> {
  const parsed = safeParse(
    request,
    (value) => operations.DeleteGuildMemberRequest$outboundSchema.parse(value),
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.nil(204, operations.DeleteGuildMemberResponse$inboundSchema.optional(), {
      hdrs: true,
    }),
