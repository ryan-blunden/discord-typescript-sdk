...
export function getCurrentUserApplicationEntitlements(
  client: DiscordCore,
  request: operations.GetCurrentUserApplicationEntitlementsRequest,
  options?: RequestOptions,
): APIPromise<
  Result<
    operations.GetCurrentUserApplicationEntitlementsResponse,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.GetCurrentUserApplicationEntitlementsRequest$outboundSchema
        .parse(value),
  ...
  const query = encodeFormQuery({
    "exclude_consumed": payload.exclude_consumed,
  ...
  >(
    M.json(
      200,
      operations.GetCurrentUserApplicationEntitlementsResponse$inboundSchema,
