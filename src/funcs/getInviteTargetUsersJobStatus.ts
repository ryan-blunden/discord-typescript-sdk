...
export function getInviteTargetUsersJobStatus(
  ...
  Result<
    operations.GetInviteTargetUsersJobStatusResponse,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.GetInviteTargetUsersJobStatusRequest$outboundSchema.parse(
        value,
      ),
  ...
  const path = pathToFunc("/invites/{code}/target-users/job-status")(
    pathParams,
  );
  ...
  >(
    M.json(
      200,
      operations.GetInviteTargetUsersJobStatusResponse$inboundSchema,
