 ...
 */
export function guildsAddMemberRole(
  client: DiscordCore,
  request: operations.AddGuildMemberRoleRequest,
  options?: RequestOptions,
): APIPromise<
  Result<
    operations.AddGuildMemberRoleResponse | undefined,
...
> {
  const parsed = safeParse(
    request,
    (value) => operations.AddGuildMemberRoleRequest$outboundSchema.parse(value),
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.nil(204, operations.AddGuildMemberRoleResponse$inboundSchema.optional(), {
      hdrs: true,
    }),
