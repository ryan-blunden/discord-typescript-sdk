 ...
 */
export function channelsCreateInviteMultipart(
  client: DiscordCore,
  request: operations.CreateChannelInviteMultipartRequest,
  options?: RequestOptions,
): APIPromise<
  Result<
    operations.CreateChannelInviteMultipartResponse | undefined,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.CreateChannelInviteMultipartRequest$outboundSchema.parse(
        value,
      ),
  ...
  const path = pathToFunc("/channels/{channel_id}/invites")(pathParams);
  ...
  const context = {
    ...
    operationID: "create_channel_invite_multipart",
    oAuth2Scopes: [],
  ...
  >(
    M.json(
      200,
      operations.CreateChannelInviteMultipartResponse$inboundSchema.optional(),
