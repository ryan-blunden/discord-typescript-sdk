...
export async function guildsScheduledEventsUpdate(
  client: DiscordCore,
  request: operations.UpdateGuildScheduledEventRequest,
  options?: RequestOptions,
): Promise<
  Result<
    operations.UpdateGuildScheduledEventResponseBody,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.UpdateGuildScheduledEventRequest$outboundSchema.parse(value),
  ...
  const [result] = await M.match<
    ...
    | ConnectionError
  >(
    M.json(200, operations.UpdateGuildScheduledEventResponseBody$inboundSchema),
