 ...
 */
export function guildTemplatesDelete(
  client: DiscordCore,
  request: operations.DeleteGuildTemplateRequest,
  options?: RequestOptions,
): APIPromise<
  Result<
    operations.DeleteGuildTemplateResponse,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.DeleteGuildTemplateRequest$outboundSchema.parse(value),
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.DeleteGuildTemplateResponse$inboundSchema, {
      hdrs: true,
      key: "Result",
    }),
