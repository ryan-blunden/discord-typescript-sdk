 ...
 */
export function emojiDeleteGuildEmoji(
  client: DiscordCore,
  request: operations.DeleteGuildEmojiRequest,
  options?: RequestOptions,
): APIPromise<
  Result<
    operations.DeleteGuildEmojiResponse | undefined,
...
> {
  const parsed = safeParse(
    request,
    (value) => operations.DeleteGuildEmojiRequest$outboundSchema.parse(value),
  ...
  const path = pathToFunc("/guilds/{guild_id}/emojis/{emoji_id}")(pathParams);
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.nil(204, operations.DeleteGuildEmojiResponse$inboundSchema.optional(), {
      hdrs: true,
    }),
