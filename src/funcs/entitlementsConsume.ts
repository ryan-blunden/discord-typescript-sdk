 ...
 */
export function entitlementsConsume(
  client: DiscordCore,
  ...
  Result<
    operations.ConsumeEntitlementResponse | undefined,
...
> {
  const parsed = safeParse(
    request,
    (value) => operations.ConsumeEntitlementRequest$outboundSchema.parse(value),
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.nil(204, operations.ConsumeEntitlementResponse$inboundSchema.optional(), {
      hdrs: true,
    }),
