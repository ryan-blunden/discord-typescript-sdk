 ...
 */
export function entitlementsDeleteTest(
  client: DiscordCore,
  ...
  Result<
    operations.DeleteEntitlementResponse | undefined,
...
> {
  ...
  const [result] = await M.match<
    ...
    | ConnectionError
  >(
    M.nil(204, operations.DeleteEntitlementResponse$inboundSchema.optional(), {
      hdrs: true,
    }),
