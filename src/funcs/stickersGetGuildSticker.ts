 ...
 */
export function stickersGetGuildSticker(
  client: DiscordCore,
  request: operations.GetGuildStickerRequest,
  options?: RequestOptions,
): APIPromise<
  Result<
    operations.GetGuildStickerResponse,
...
> {
  const parsed = safeParse(
    request,
    (value) => operations.GetGuildStickerRequest$outboundSchema.parse(value),
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.GetGuildStickerResponse$inboundSchema, {
      hdrs: true,
      key: "Result",
    }),
