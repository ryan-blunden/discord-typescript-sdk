 ...
 */
export function applicationsGetOAuth2Me(
  client: DiscordCore,
  options?: RequestOptions,
): APIPromise<
  Result<
    operations.GetMyOauth2ApplicationResponse,
...
> {
  const path = pathToFunc("/oauth2/applications/@me")();
  ...
  const [result] = await M.match<
    ...
    | ConnectionError
  >(
    M.json(200, operations.GetMyOauth2ApplicationResponse$inboundSchema, {
      hdrs: true,
      key: "Result",
    }),
