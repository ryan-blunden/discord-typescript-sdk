 ...
 */
export function guildRoleMemberCounts(
  client: DiscordCore,
  request: operations.GuildRoleMemberCountsRequest,
  options?: RequestOptions,
): APIPromise<
  Result<
    operations.GuildRoleMemberCountsResponse,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.GuildRoleMemberCountsRequest$outboundSchema.parse(value),
  ...
  const path = pathToFunc("/guilds/{guild_id}/roles/member-counts")(pathParams);
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.GuildRoleMemberCountsResponse$inboundSchema, {
      hdrs: true,
      key: "Result",
    }),
