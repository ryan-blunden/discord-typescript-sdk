 ...
 */
export function guildsRemoveMemberRole(
  client: DiscordCore,
  request: operations.DeleteGuildMemberRoleRequest,
  options?: RequestOptions,
): APIPromise<
  Result<
    operations.DeleteGuildMemberRoleResponse | undefined,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.DeleteGuildMemberRoleRequest$outboundSchema.parse(value),
  ...
  >(
    M.nil(
      204,
      operations.DeleteGuildMemberRoleResponse$inboundSchema.optional(),
      { hdrs: true },
    ),
