 ...
 */
export function soundboardsCreateGuildSoundboardSound(
  client: DiscordCore,
  request: operations.CreateGuildSoundboardSoundRequest,
  options?: RequestOptions,
): APIPromise<
  Result<
    operations.CreateGuildSoundboardSoundResponse,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.CreateGuildSoundboardSoundRequest$outboundSchema.parse(value),
  ...
  const path = pathToFunc("/guilds/{guild_id}/soundboard-sounds")(pathParams);
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(201, operations.CreateGuildSoundboardSoundResponse$inboundSchema, {
      hdrs: true,
      key: "Result",
    }),
