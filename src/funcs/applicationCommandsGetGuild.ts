 ...
 */
export function applicationCommandsGetGuild(
  client: DiscordCore,
  ...
  Result<
    operations.GetGuildApplicationCommandResponse,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.GetGuildApplicationCommandRequest$outboundSchema.parse(value),
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.GetGuildApplicationCommandResponse$inboundSchema, {
      hdrs: true,
      key: "Result",
    }),
