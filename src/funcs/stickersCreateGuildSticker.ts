 ...
 */
export function stickersCreateGuildSticker(
  client: DiscordCore,
  request: operations.CreateGuildStickerRequest,
  options?: RequestOptions,
): APIPromise<
  Result<
    operations.CreateGuildStickerResponse,
...
> {
  const parsed = safeParse(
    request,
    (value) => operations.CreateGuildStickerRequest$outboundSchema.parse(value),
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(201, operations.CreateGuildStickerResponse$inboundSchema, {
      hdrs: true,
      key: "Result",
    }),
