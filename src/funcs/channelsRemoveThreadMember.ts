 ...
 */
export function channelsRemoveThreadMember(
  client: DiscordCore,
  request: operations.DeleteThreadMemberRequest,
  options?: RequestOptions,
): APIPromise<
  Result<
    operations.DeleteThreadMemberResponse | undefined,
...
> {
  const parsed = safeParse(
    request,
    (value) => operations.DeleteThreadMemberRequest$outboundSchema.parse(value),
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.nil(204, operations.DeleteThreadMemberResponse$inboundSchema.optional(), {
      hdrs: true,
    }),
