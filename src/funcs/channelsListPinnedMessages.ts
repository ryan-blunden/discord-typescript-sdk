...
export function channelsListPinnedMessages(
  ...
  Result<
    operations.DeprecatedListPinsResponse,
...
> {
  const parsed = safeParse(
    request,
    (value) => operations.DeprecatedListPinsRequest$outboundSchema.parse(value),
  ...
  const path = pathToFunc("/channels/{channel_id}/pins")(pathParams);
  ...
  const [result] = await M.match<
    ...
    | ConnectionError
  >(
    M.json(200, operations.DeprecatedListPinsResponse$inboundSchema, {
      hdrs: true,
      key: "Result",
    }),
