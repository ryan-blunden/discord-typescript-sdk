 ...
 */
export function applicationCommandsBulkSet(
  client: DiscordCore,
  ...
  Result<
    operations.BulkSetApplicationCommandsResponse,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.BulkSetApplicationCommandsRequest$outboundSchema.parse(value),
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.BulkSetApplicationCommandsResponse$inboundSchema, {
      hdrs: true,
      key: "Result",
    }),
