 ...
 */
export function messagesDeleteAllReactionsForEmoji(
  client: DiscordCore,
  request: operations.DeleteAllMessageReactionsByEmojiRequest,
  options?: RequestOptions,
): APIPromise<
  Result<
    operations.DeleteAllMessageReactionsByEmojiResponse | undefined,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.DeleteAllMessageReactionsByEmojiRequest$outboundSchema.parse(
        value,
      ),
  ...
  const pathParams = {
    ...
    emoji_name: encodeSimple("emoji_name", payload.emoji_name, {
      explode: false,
      charEncoding: "percent",
    }),
  ...
  >(
    M.nil(
      204,
      operations.DeleteAllMessageReactionsByEmojiResponse$inboundSchema
        .optional(),
      { hdrs: true },
    ),
