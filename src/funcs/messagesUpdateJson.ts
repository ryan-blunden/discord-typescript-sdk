 ...
 */
export function messagesUpdateJson(
  client: DiscordCore,
  request: operations.UpdateMessageJsonRequest,
  options?: RequestOptions,
): APIPromise<
  Result<
    operations.UpdateMessageJsonResponse,
...
> {
  const parsed = safeParse(
    request,
    (value) => operations.UpdateMessageJsonRequest$outboundSchema.parse(value),
  ...
  const body = encodeJSON("body", payload.MessageEditRequestPartial, {
    explode: true,
  });
  ...
  const context = {
    ...
    operationID: "update_message_json",
    oAuth2Scopes: null,
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.UpdateMessageJsonResponse$inboundSchema, {
      hdrs: true,
      key: "Result",
    }),
