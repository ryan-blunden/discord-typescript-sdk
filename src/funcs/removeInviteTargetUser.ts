 ...
 */
export function removeInviteTargetUser(
  client: DiscordCore,
  request: operations.RemoveInviteTargetUserRequest,
  options?: RequestOptions,
): APIPromise<
  Result<
    operations.RemoveInviteTargetUserResponse | undefined,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.RemoveInviteTargetUserRequest$outboundSchema.parse(value),
  ...
  const path = pathToFunc("/invites/{code}/target-users/{user_id}")(pathParams);
  ...
  >(
    M.nil(
      204,
      operations.RemoveInviteTargetUserResponse$inboundSchema.optional(),
      { hdrs: true },
    ),
