...
> {
  const parsed = safeParse(
    request,
    (value) => operations.ListPinsRequest$outboundSchema.parse(value),
  ...
  const path = pathToFunc("/channels/{channel_id}/messages/pins")(pathParams);
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.ListPinsResponse$inboundSchema, {
      hdrs: true,
      key: "Result",
    }),
