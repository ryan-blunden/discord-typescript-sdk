 ...
 */
export function emojiUpdateApplicationEmoji(
  client: DiscordCore,
  request: operations.UpdateApplicationEmojiRequest,
  options?: RequestOptions,
): APIPromise<
  Result<
    operations.UpdateApplicationEmojiResponse,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.UpdateApplicationEmojiRequest$outboundSchema.parse(value),
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.UpdateApplicationEmojiResponse$inboundSchema, {
      hdrs: true,
      key: "Result",
    }),
