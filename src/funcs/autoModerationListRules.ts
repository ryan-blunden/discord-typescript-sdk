 ...
 */
export function autoModerationListRules(
  client: DiscordCore,
  request: operations.ListAutoModerationRulesRequest,
  options?: RequestOptions,
): APIPromise<
  Result<
    Array<operations.ListAutoModerationRulesResponseBody | null>,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.ListAutoModerationRulesRequest$outboundSchema.parse(value),
  ...
  const path = pathToFunc("/guilds/{guild_id}/auto-moderation/rules")(
    pathParams,
  );
  ...
  >(
    M.json(
      ...
      z.array(
        z.nullable(
          operations.ListAutoModerationRulesResponseBody$inboundSchema,
        ),
      ),
    ),
