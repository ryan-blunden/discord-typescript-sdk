 ...
 */
export function messagesDeleteUserReaction(
  client: DiscordCore,
  request: operations.DeleteUserMessageReactionRequest,
  options?: RequestOptions,
): APIPromise<
  Result<
    operations.DeleteUserMessageReactionResponse | undefined,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.DeleteUserMessageReactionRequest$outboundSchema.parse(value),
  ...
  >(
    M.nil(
      204,
      operations.DeleteUserMessageReactionResponse$inboundSchema.optional(),
      { hdrs: true },
    ),
