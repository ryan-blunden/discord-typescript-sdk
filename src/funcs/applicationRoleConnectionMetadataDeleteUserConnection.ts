 ...
 */
export function applicationRoleConnectionMetadataDeleteUserConnection(
  client: DiscordCore,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.DeleteApplicationUserRoleConnectionRequest$outboundSchema
        .parse(value),
  ...
  >(
    M.nil(
      204,
      operations.DeleteApplicationUserRoleConnectionResponse$inboundSchema
        .optional(),
      { hdrs: true },
    ),
