 ...
 */
export function lobbiesGet(
  client: DiscordCore,
  request: operations.GetLobbyRequest,
  options?: RequestOptions,
): APIPromise<
  Result<
    operations.GetLobbyResponse,
...
> {
  const parsed = safeParse(
    request,
    (value) => operations.GetLobbyRequest$outboundSchema.parse(value),
  ...
  const [result] = await M.match<
    ...
    | ConnectionError
  >(
    M.json(200, operations.GetLobbyResponse$inboundSchema, {
      hdrs: true,
      key: "Result",
    }),
