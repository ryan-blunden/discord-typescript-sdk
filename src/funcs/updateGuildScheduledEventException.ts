 ...
 */
export function updateGuildScheduledEventException(
  client: DiscordCore,
  request: operations.UpdateGuildScheduledEventExceptionRequest,
  options?: RequestOptions,
): APIPromise<
  Result<
    operations.UpdateGuildScheduledEventExceptionResponse,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.UpdateGuildScheduledEventExceptionRequest$outboundSchema.parse(
        value,
      ),
  ...
  const body = encodeJSON(
    "body",
    payload.GuildScheduledEventExceptionPatchRequestPartial,
    { explode: true },
  );

  const pathParams = {
    exception_id: encodeSimple("exception_id", payload.exception_id, {
      explode: false,
  ...
  >(
    M.json(
      200,
      operations.UpdateGuildScheduledEventExceptionResponse$inboundSchema,
