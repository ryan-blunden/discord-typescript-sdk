 ...
 */
export function channelsListJoinedPrivateArchivedThreads(
  client: DiscordCore,
  request: operations.ListMyPrivateArchivedThreadsRequest,
  options?: RequestOptions,
): APIPromise<
  Result<
    operations.ListMyPrivateArchivedThreadsResponse,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.ListMyPrivateArchivedThreadsRequest$outboundSchema.parse(
        value,
      ),
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.ListMyPrivateArchivedThreadsResponse$inboundSchema, {
      hdrs: true,
      key: "Result",
    }),
