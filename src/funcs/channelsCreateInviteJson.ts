 ...
 */
export function channelsCreateInviteJson(
  client: DiscordCore,
  request: operations.CreateChannelInviteJsonRequest,
  options?: RequestOptions,
): APIPromise<
  Result<
    operations.CreateChannelInviteJsonResponse | undefined,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.CreateChannelInviteJsonRequest$outboundSchema.parse(value),
  ...
  const context = {
    ...
    operationID: "create_channel_invite_json",
    oAuth2Scopes: null,
  ...
  >(
    M.json(
      200,
      operations.CreateChannelInviteJsonResponse$inboundSchema.optional(),
