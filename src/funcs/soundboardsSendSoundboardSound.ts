 ...
 */
export function soundboardsSendSoundboardSound(
  client: DiscordCore,
  request: operations.SendSoundboardSoundRequest,
  options?: RequestOptions,
): APIPromise<
  Result<
    operations.SendSoundboardSoundResponse | undefined,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.SendSoundboardSoundRequest$outboundSchema.parse(value),
  ...
  const body = encodeJSON("body", payload.SoundboardSoundSendRequest, {
    explode: true,
  });
  ...
  const path = pathToFunc("/channels/{channel_id}/send-soundboard-sound")(
    pathParams,
  );
  ...
  >(
    M.nil(
      204,
      operations.SendSoundboardSoundResponse$inboundSchema.optional(),
      { hdrs: true },
    ),
