 ...
 */
export function soundboardsListGuildSoundboardSounds(
  client: DiscordCore,
  request: operations.ListGuildSoundboardSoundsRequest,
  options?: RequestOptions,
): APIPromise<
  Result<
    components.ListGuildSoundboardSoundsResponse,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.ListGuildSoundboardSoundsRequest$outboundSchema.parse(value),
  ...
  const [result] = await M.match<
    ...
    | ConnectionError
  >(
    M.json(200, components.ListGuildSoundboardSoundsResponse$inboundSchema),
