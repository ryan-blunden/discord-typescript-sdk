 ...
 */
export function soundboardsGetSoundboardDefaultSounds(
  client: DiscordCore,
  options?: RequestOptions,
): APIPromise<
  Result<
    operations.GetSoundboardDefaultSoundsResponse,
...
> {
  ...
  const [result] = await M.match<
    ...
    | ConnectionError
  >(
    M.json(200, operations.GetSoundboardDefaultSoundsResponse$inboundSchema, {
      hdrs: true,
      key: "Result",
    }),
