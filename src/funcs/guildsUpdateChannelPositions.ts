 ...
 */
export function guildsUpdateChannelPositions(
  client: DiscordCore,
  request: operations.BulkUpdateGuildChannelsRequest,
  options?: RequestOptions,
): APIPromise<
  Result<
    operations.BulkUpdateGuildChannelsResponse | undefined,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.BulkUpdateGuildChannelsRequest$outboundSchema.parse(value),
  ...
  >(
    M.nil(
      204,
      operations.BulkUpdateGuildChannelsResponse$inboundSchema.optional(),
      { hdrs: true },
    ),
