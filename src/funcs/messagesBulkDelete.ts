 ...
 */
export function messagesBulkDelete(
  client: DiscordCore,
  request: operations.BulkDeleteMessagesRequest,
  options?: RequestOptions,
): APIPromise<
  Result<
    operations.BulkDeleteMessagesResponse | undefined,
...
> {
  const parsed = safeParse(
    request,
    (value) => operations.BulkDeleteMessagesRequest$outboundSchema.parse(value),
  ...
  const path = pathToFunc("/channels/{channel_id}/messages/bulk-delete")(
    pathParams,
  );
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.nil(204, operations.BulkDeleteMessagesResponse$inboundSchema.optional(), {
      hdrs: true,
    }),
