 ...
 */
export function bulkUpdateLobbyMembers(
  client: DiscordCore,
  request: operations.BulkUpdateLobbyMembersRequest,
  options?: RequestOptions,
): APIPromise<
  Result<
    operations.BulkUpdateLobbyMembersResponse,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.BulkUpdateLobbyMembersRequest$outboundSchema.parse(value),
  ...
  const path = pathToFunc("/lobbies/{lobby_id}/members/bulk")(pathParams);
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.BulkUpdateLobbyMembersResponse$inboundSchema, {
      hdrs: true,
      key: "Result",
    }),
