 ...
 */
export function channelsSetPermissionOverwrite(
  client: DiscordCore,
  request: operations.SetChannelPermissionOverwriteRequest,
  options?: RequestOptions,
): APIPromise<
  Result<
    operations.SetChannelPermissionOverwriteResponse | undefined,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.SetChannelPermissionOverwriteRequest$outboundSchema.parse(
        value,
      ),
  ...
  >(
    M.nil(
      204,
      operations.SetChannelPermissionOverwriteResponse$inboundSchema.optional(),
      { hdrs: true },
    ),
