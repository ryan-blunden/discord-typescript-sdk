...
export async function guildsGet(
  client: DiscordCore,
  request: operations.GetGuildRequest,
  options?: RequestOptions,
): Promise<
  Result<
    components.GuildWithCountsResponse,
...
> {
  const parsed = safeParse(
    request,
    (value) => operations.GetGuildRequest$outboundSchema.parse(value),
  ...
  const [result] = await M.match<
    ...
    | ConnectionError
  >(
    M.json(200, components.GuildWithCountsResponse$inboundSchema),
