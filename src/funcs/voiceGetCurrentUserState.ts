 ...
 */
export function voiceGetCurrentUserState(
  client: DiscordCore,
  request: operations.GetSelfVoiceStateRequest,
  options?: RequestOptions,
): APIPromise<
  Result<
    operations.GetSelfVoiceStateResponse,
...
> {
  const parsed = safeParse(
    request,
    (value) => operations.GetSelfVoiceStateRequest$outboundSchema.parse(value),
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.GetSelfVoiceStateResponse$inboundSchema, {
      hdrs: true,
      key: "Result",
    }),
