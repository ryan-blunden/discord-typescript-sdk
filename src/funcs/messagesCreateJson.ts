 ...
 */
export function messagesCreateJson(
  client: DiscordCore,
  request: operations.CreateMessageJsonRequest,
  options?: RequestOptions,
): APIPromise<
  Result<
    operations.CreateMessageJsonResponse,
...
> {
  const parsed = safeParse(
    request,
    (value) => operations.CreateMessageJsonRequest$outboundSchema.parse(value),
  ...
  const context = {
    ...
    operationID: "create_message_json",
    oAuth2Scopes: [],
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.CreateMessageJsonResponse$inboundSchema, {
      hdrs: true,
      key: "Result",
    }),
