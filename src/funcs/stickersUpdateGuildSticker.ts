 ...
 */
export function stickersUpdateGuildSticker(
  client: DiscordCore,
  request: operations.UpdateGuildStickerRequest,
  options?: RequestOptions,
): APIPromise<
  Result<
    operations.UpdateGuildStickerResponse,
...
> {
  const parsed = safeParse(
    request,
    (value) => operations.UpdateGuildStickerRequest$outboundSchema.parse(value),
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.UpdateGuildStickerResponse$inboundSchema, {
      hdrs: true,
      key: "Result",
    }),
