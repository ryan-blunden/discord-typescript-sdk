 ...
 */
export function updateUserMessageExternalModerationMetadata(
  client: DiscordCore,
...
async function $do(
  ...
  [
    Result<
      | operations.UpdateUserMessageExternalModerationMetadataResponse
      | undefined,
      | errors.RatelimitedResponse
      | errors.ErrorResponse
      | DiscordError
...
> {
  const parsed = safeParse(
    ...
    (value) =>
      operations
        .UpdateUserMessageExternalModerationMetadataRequest$outboundSchema
        .parse(value),
  ...
  const pathParams = {
    ...
    user_id_1: encodeSimple("user_id_1", payload.user_id_1, {
      explode: false,
      charEncoding: "percent",
    }),
    user_id_2: encodeSimple("user_id_2", payload.user_id_2, {
      explode: false,
      charEncoding: "percent",
    }),
  };
  ...
  >(
    M.nil(
      204,
      operations
        .UpdateUserMessageExternalModerationMetadataResponse$inboundSchema
        .optional(),
      { hdrs: true },
    ),
