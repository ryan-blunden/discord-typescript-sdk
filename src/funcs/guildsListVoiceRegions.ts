 ...
 */
export function guildsListVoiceRegions(
  client: DiscordCore,
  request: operations.ListGuildVoiceRegionsRequest,
  options?: RequestOptions,
): APIPromise<
  Result<
    operations.ListGuildVoiceRegionsResponse,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.ListGuildVoiceRegionsRequest$outboundSchema.parse(value),
  ...
  const path = pathToFunc("/guilds/{guild_id}/regions")(pathParams);
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.ListGuildVoiceRegionsResponse$inboundSchema, {
      hdrs: true,
      key: "Result",
    }),
