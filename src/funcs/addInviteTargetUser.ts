 ...
 */
export function addInviteTargetUser(
  client: DiscordCore,
  request: operations.AddInviteTargetUserRequest,
  options?: RequestOptions,
): APIPromise<
  Result<
    operations.AddInviteTargetUserResponse | undefined,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.AddInviteTargetUserRequest$outboundSchema.parse(value),
  ...
  >(
    M.nil(
      204,
      operations.AddInviteTargetUserResponse$inboundSchema.optional(),
      { hdrs: true },
    ),
