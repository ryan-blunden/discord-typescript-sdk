 ...
 */
export function channelsJoinThread(
  client: DiscordCore,
  request: operations.JoinThreadRequest,
  options?: RequestOptions,
): APIPromise<
  Result<
    operations.JoinThreadResponse | undefined,
...
> {
  const parsed = safeParse(
    request,
    (value) => operations.JoinThreadRequest$outboundSchema.parse(value),
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.nil(204, operations.JoinThreadResponse$inboundSchema.optional(), {
      hdrs: true,
    }),
