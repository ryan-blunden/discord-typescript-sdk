 ...
 */
export function channelsStartThreadMultipart(
  client: DiscordCore,
  request: operations.CreateThreadMultipartRequest,
  options?: RequestOptions,
): APIPromise<
  Result<
    components.CreatedThreadResponse,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.CreateThreadMultipartRequest$outboundSchema.parse(value),
  ...
  const context = {
    ...
    operationID: "create_thread_multipart",
    oAuth2Scopes: [],
  ...
  const [result] = await M.match<
    ...
    | ConnectionError
  >(
    M.json(201, components.CreatedThreadResponse$inboundSchema),
