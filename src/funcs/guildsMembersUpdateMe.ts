...
export async function guildsMembersUpdateMe(
  client: DiscordCore,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.UpdateMyGuildMemberRequest$outboundSchema.parse(value),
  ...
  const path = pathToFunc("/guilds/{guild_id}/members/@me")(pathParams);
