...
export async function applicationsEmojisList(
  client: DiscordCore,
  request: operations.ListApplicationEmojisRequest,
  options?: RequestOptions,
): Promise<
  Result<
    components.ListApplicationEmojisResponse,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.ListApplicationEmojisRequest$outboundSchema.parse(value),
  ...
  const [result] = await M.match<
    ...
    | ConnectionError
  >(
    M.json(200, components.ListApplicationEmojisResponse$inboundSchema),
