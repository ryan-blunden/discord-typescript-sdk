 ...
 */
export function webhooksGetMessage(
  client: DiscordCore,
  ...
  Result<
    operations.GetWebhookMessageResponse,
...
> {
  const parsed = safeParse(
    request,
    (value) => operations.GetWebhookMessageRequest$outboundSchema.parse(value),
  ...
  const [result] = await M.match<
    ...
    | ConnectionError
  >(
    M.json(200, operations.GetWebhookMessageResponse$inboundSchema, {
      hdrs: true,
      key: "Result",
    }),
