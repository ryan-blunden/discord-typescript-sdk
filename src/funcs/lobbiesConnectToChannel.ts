 ...
 */
export function lobbiesConnectToChannel(
  client: DiscordCore,
  ...
  Result<
    operations.EditLobbyChannelLinkResponse,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.EditLobbyChannelLinkRequest$outboundSchema.parse(value),
  ...
  const path = pathToFunc("/lobbies/{lobby_id}/channel-linking")(pathParams);
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.EditLobbyChannelLinkResponse$inboundSchema, {
      hdrs: true,
      key: "Result",
    }),
