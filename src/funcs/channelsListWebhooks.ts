...
export async function channelsListWebhooks(
  client: DiscordCore,
  request: operations.ListChannelWebhooksRequest,
  options?: RequestOptions,
): Promise<
  Result<
    Array<operations.ListChannelWebhooksResponseBody>,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.ListChannelWebhooksRequest$outboundSchema.parse(value),
  ...
  const path = pathToFunc("/channels/{channel_id}/webhooks")(pathParams);
  ...
  >(
    M.json(
      200,
      z.array(operations.ListChannelWebhooksResponseBody$inboundSchema),
    ),
