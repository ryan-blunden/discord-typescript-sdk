...
export async function guildsScheduledEventsGet(
  client: DiscordCore,
  request: operations.GetGuildScheduledEventRequest,
  options?: RequestOptions,
): Promise<
  Result<
    operations.GetGuildScheduledEventResponseBody,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.GetGuildScheduledEventRequest$outboundSchema.parse(value),
  ...
  const [result] = await M.match<
    ...
    | ConnectionError
  >(
    M.json(200, operations.GetGuildScheduledEventResponseBody$inboundSchema),
