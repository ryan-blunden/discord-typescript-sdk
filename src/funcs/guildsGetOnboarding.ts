...
export async function guildsGetOnboarding(
  client: DiscordCore,
  request: operations.GetGuildsOnboardingRequest,
  options?: RequestOptions,
): Promise<
  Result<
    components.UserGuildOnboardingResponse,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.GetGuildsOnboardingRequest$outboundSchema.parse(value),
  ...
  const [result] = await M.match<
    ...
    | ConnectionError
  >(
    M.json(200, components.UserGuildOnboardingResponse$inboundSchema),
