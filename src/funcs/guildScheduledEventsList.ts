 ...
 */
export function guildScheduledEventsList(
  client: DiscordCore,
  request: operations.ListGuildScheduledEventsRequest,
  options?: RequestOptions,
): APIPromise<
  Result<
    operations.ListGuildScheduledEventsResponse,
...
> {
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.ListGuildScheduledEventsResponse$inboundSchema, {
      hdrs: true,
      key: "Result",
    }),
