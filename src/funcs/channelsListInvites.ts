 ...
 */
export function channelsListInvites(
  client: DiscordCore,
  request: operations.ListChannelInvitesRequest,
  options?: RequestOptions,
): APIPromise<
  Result<
    operations.ListChannelInvitesResponse,
...
> {
  const parsed = safeParse(
    request,
    (value) => operations.ListChannelInvitesRequest$outboundSchema.parse(value),
  ...
  const [result] = await M.match<
    ...
    | ConnectionError
  >(
    M.json(200, operations.ListChannelInvitesResponse$inboundSchema, {
      hdrs: true,
      key: "Result",
    }),
