 ...
 */
export function channelsAddThreadMember(
  client: DiscordCore,
  request: operations.AddThreadMemberRequest,
  options?: RequestOptions,
): APIPromise<
  Result<
    operations.AddThreadMemberResponse | undefined,
...
> {
  const parsed = safeParse(
    request,
    (value) => operations.AddThreadMemberRequest$outboundSchema.parse(value),
  ...
  const [result] = await M.match<
    ...
    | ConnectionError
  >(
    M.nil(204, operations.AddThreadMemberResponse$inboundSchema.optional(), {
      hdrs: true,
    }),
