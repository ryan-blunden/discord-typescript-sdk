 ...
 */
export function bulkAddInviteTargetUsers(
  client: DiscordCore,
  request: operations.BulkAddInviteTargetUsersRequest,
  options?: RequestOptions,
): APIPromise<
  Result<
    operations.BulkAddInviteTargetUsersResponse | undefined,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.BulkAddInviteTargetUsersRequest$outboundSchema.parse(value),
  ...
  const path = pathToFunc("/invites/{code}/target-users/bulk-add")(pathParams);
  ...
  >(
    M.nil(
      204,
      operations.BulkAddInviteTargetUsersResponse$inboundSchema.optional(),
      { hdrs: true },
    ),
