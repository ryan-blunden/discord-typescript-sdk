...
export function lobbiesCreate(
  ...
  Result<
    operations.CreateLobbyResponse,
...
> {
  const parsed = safeParse(
    request,
    (value) => operations.CreateLobbyRequestBody$outboundSchema.parse(value),
  ...
  const [result] = await M.match<
    ...
    | ConnectionError
  >(
    M.json(201, operations.CreateLobbyResponse$inboundSchema, {
      hdrs: true,
      key: "Result",
    }),
