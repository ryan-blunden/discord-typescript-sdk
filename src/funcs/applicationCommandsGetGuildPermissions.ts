 ...
 */
export function applicationCommandsGetGuildPermissions(
  client: DiscordCore,
  ...
  Result<
    operations.GetGuildApplicationCommandPermissionsResponse,
...
> {
  ...
  >(
    M.json(
      200,
      operations.GetGuildApplicationCommandPermissionsResponse$inboundSchema,
