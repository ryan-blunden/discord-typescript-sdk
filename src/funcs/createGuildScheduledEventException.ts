 ...
 */
export function createGuildScheduledEventException(
  client: DiscordCore,
  request: operations.CreateGuildScheduledEventExceptionRequest,
  options?: RequestOptions,
): APIPromise<
  Result<
    operations.CreateGuildScheduledEventExceptionResponse,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.CreateGuildScheduledEventExceptionRequest$outboundSchema.parse(
        value,
      ),
  ...
  const body = encodeJSON(
    "body",
    payload.GuildScheduledEventExceptionCreateRequest,
    { explode: true },
  );
  ...
  >(
    M.json(
      200,
      operations.CreateGuildScheduledEventExceptionResponse$inboundSchema,
