 ...
 */
export function soundboardsGetGuildSoundboardSound(
  client: DiscordCore,
  request: operations.GetGuildSoundboardSoundRequest,
  options?: RequestOptions,
): APIPromise<
  Result<
    operations.GetGuildSoundboardSoundResponse,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.GetGuildSoundboardSoundRequest$outboundSchema.parse(value),
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.GetGuildSoundboardSoundResponse$inboundSchema, {
      hdrs: true,
      key: "Result",
    }),
