 ...
 */
export function applicationsGetOpenIDConnectUserInfo(
  client: DiscordCore,
  security: operations.GetOpenidConnectUserinfoSecurity,
  options?: RequestOptions,
): APIPromise<
  Result<
    operations.GetOpenidConnectUserinfoResponse,
...
> {
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.GetOpenidConnectUserinfoResponse$inboundSchema, {
      hdrs: true,
      key: "Result",
    }),
