 ...
 */
export function guildTemplatesCreate(
  client: DiscordCore,
  request: operations.CreateGuildTemplateRequest,
  options?: RequestOptions,
): APIPromise<
  Result<
    operations.CreateGuildTemplateResponse,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.CreateGuildTemplateRequest$outboundSchema.parse(value),
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.CreateGuildTemplateResponse$inboundSchema, {
      hdrs: true,
      key: "Result",
    }),
