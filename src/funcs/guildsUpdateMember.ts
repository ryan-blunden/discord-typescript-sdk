 ...
 */
export function guildsUpdateMember(
  client: DiscordCore,
  request: operations.UpdateGuildMemberRequest,
  options?: RequestOptions,
): APIPromise<
  Result<
    operations.UpdateGuildMemberResponse | undefined,
...
> {
  const parsed = safeParse(
    request,
    (value) => operations.UpdateGuildMemberRequest$outboundSchema.parse(value),
  ...
  const [result] = await M.match<
    ...
    | ConnectionError
  >(
    M.json(200, operations.UpdateGuildMemberResponse$inboundSchema.optional(), {
      hdrs: true,
      key: "Result",
    }),
    M.nil(204, operations.UpdateGuildMemberResponse$inboundSchema.optional(), {
      hdrs: true,
    }),
