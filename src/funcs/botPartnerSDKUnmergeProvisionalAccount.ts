 ...
 */
export function botPartnerSDKUnmergeProvisionalAccount(
  client: DiscordCore,
...
> {
  ...
  const path = pathToFunc("/partner-sdk/provisional-accounts/unmerge/bot")();
  ...
  >(
    M.nil(
      204,
      operations.BotPartnerSDKUnmergeProvisionalAccountResponse$inboundSchema
        .optional(),
      { hdrs: true },
    ),
