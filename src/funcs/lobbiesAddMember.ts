 ...
 */
export function lobbiesAddMember(
  client: DiscordCore,
  request: operations.AddLobbyMemberRequest,
  options?: RequestOptions,
): APIPromise<
  Result<
    operations.AddLobbyMemberResponse,
...
> {
  const parsed = safeParse(
    request,
    (value) => operations.AddLobbyMemberRequest$outboundSchema.parse(value),
  ...
  const [result] = await M.match<
    ...
    | ConnectionError
  >(
    M.json(200, operations.AddLobbyMemberResponse$inboundSchema, {
      hdrs: true,
      key: "Result",
    }),
