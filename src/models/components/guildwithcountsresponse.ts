...
> = z.object({
  ...
  mfa_level: z.literal(0).default(0).optional(),
  ...
  premium_tier: z.literal(0).default(0).optional(),
  ...
  nsfw: z.boolean(),
  nsfw_level: z.literal(0).default(0).optional(),
 ...
 */
export namespace GuildWithCountsResponse$ {
  /** @deprecated use `GuildWithCountsResponse$inboundSchema` instead. */
  export const inboundSchema = GuildWithCountsResponse$inboundSchema;
  /** @deprecated use `GuildWithCountsResponse$outboundSchema` instead. */
