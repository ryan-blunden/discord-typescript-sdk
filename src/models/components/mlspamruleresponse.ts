 ...
 */
export namespace MLSpamRuleResponseActions$ {
  /** @deprecated use `MLSpamRuleResponseActions$inboundSchema` instead. */
  export const inboundSchema = MLSpamRuleResponseActions$inboundSchema;
  /** @deprecated use `MLSpamRuleResponseActions$outboundSchema` instead. */
...
export namespace MLSpamRuleResponse$ {
  /** @deprecated use `MLSpamRuleResponse$inboundSchema` instead. */
  export const inboundSchema = MLSpamRuleResponse$inboundSchema;
  /** @deprecated use `MLSpamRuleResponse$outboundSchema` instead. */
