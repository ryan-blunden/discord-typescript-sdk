...
> = z.object({
  ...
  default_message_notifications: z.nullable(z.literal(0).default(0)).optional(),
  explicit_content_filter: z.nullable(z.literal(0).default(0)).optional(),
  preferred_locale: z.nullable(z.literal("ar").default("ar")).optional(),
  afk_timeout: z.nullable(z.literal(60).default(60)).optional(),
