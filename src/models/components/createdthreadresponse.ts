 ...
 */
export namespace CreatedThreadResponseType$ {
  /** @deprecated use `CreatedThreadResponseType$inboundSchema` instead. */
  export const inboundSchema = CreatedThreadResponseType$inboundSchema;
  /** @deprecated use `CreatedThreadResponseType$outboundSchema` instead. */
  export const outboundSchema = CreatedThreadResponseType$outboundSchema;
}
...
> = z.object({
  ...
  video_quality_mode: z.literal(1).default(1).optional(),
 ...
 * @deprecated This namespace will be removed in future versions. Use schemas and types that are exported directly from this module.
 */
export namespace CreatedThreadResponse$ {
  /** @deprecated use `CreatedThreadResponse$inboundSchema` instead. */
  export const inboundSchema = CreatedThreadResponse$inboundSchema;
  /** @deprecated use `CreatedThreadResponse$outboundSchema` instead. */
  export const outboundSchema = CreatedThreadResponse$outboundSchema;
  /** @deprecated use `CreatedThreadResponse$Outbound` instead. */
  export type Outbound = CreatedThreadResponse$Outbound;
}
