...
export namespace ChannelSelectComponentForMessageRequest$ {
  /** @deprecated use `ChannelSelectComponentForMessageRequest$inboundSchema` instead. */
  export const inboundSchema =
    ChannelSelectComponentForMessageRequest$inboundSchema;
  /** @deprecated use `ChannelSelectComponentForMessageRequest$outboundSchema` instead. */
  export const outboundSchema =
    ChannelSelectComponentForMessageRequest$outboundSchema;
  /** @deprecated use `ChannelSelectComponentForMessageRequest$Outbound` instead. */
  export type Outbound = ChannelSelectComponentForMessageRequest$Outbound;
}
