...
export namespace RoleSelectComponentForMessageRequest$ {
  /** @deprecated use `RoleSelectComponentForMessageRequest$inboundSchema` instead. */
  export const inboundSchema =
    RoleSelectComponentForMessageRequest$inboundSchema;
  /** @deprecated use `RoleSelectComponentForMessageRequest$outboundSchema` instead. */
  export const outboundSchema =
    RoleSelectComponentForMessageRequest$outboundSchema;
  /** @deprecated use `RoleSelectComponentForMessageRequest$Outbound` instead. */
  export type Outbound = RoleSelectComponentForMessageRequest$Outbound;
}
