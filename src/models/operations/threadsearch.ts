...
> = z.object({
  ...
  tag_setting: z.literal("match_all").default("match_all").optional(),
  archived: z.boolean().optional(),
  sort_by: z.literal("relevance").default("relevance").optional(),
  sort_order: z.literal("asc").default("asc").optional(),
