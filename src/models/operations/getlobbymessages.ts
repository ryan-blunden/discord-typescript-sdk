 ...
 * @deprecated This namespace will be removed in future versions. Use schemas and types that are exported directly from this module.
 */
export namespace GetLobbyMessagesResponse$ {
  /** @deprecated use `GetLobbyMessagesResponse$inboundSchema` instead. */
  export const inboundSchema = GetLobbyMessagesResponse$inboundSchema;
  /** @deprecated use `GetLobbyMessagesResponse$outboundSchema` instead. */
  export const outboundSchema = GetLobbyMessagesResponse$outboundSchema;
  /** @deprecated use `GetLobbyMessagesResponse$Outbound` instead. */
  export type Outbound = GetLobbyMessagesResponse$Outbound;
}
