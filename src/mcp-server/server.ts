...
import { tool$actionGuildJoinRequest } from "./tools/actionGuildJoinRequest.js";
import { tool$addInviteTargetUser } from "./tools/addInviteTargetUser.js";
...
import { tool$applicationsGetGateway } from "./tools/applicationsGetGateway.js";
...
import { tool$applicationsGetPublicKeys } from "./tools/applicationsGetPublicKeys.js";
import { tool$applicationsPartnerSDKToken } from "./tools/applicationsPartnerSDKToken.js";
import { tool$applicationsPartnerSDKUnmergeProvisionalAccount } from "./tools/applicationsPartnerSDKUnmergeProvisionalAccount.js";
...
import { tool$bulkAddInviteTargetUsers } from "./tools/bulkAddInviteTargetUsers.js";
import { tool$bulkRemoveInviteTargetUsers } from "./tools/bulkRemoveInviteTargetUsers.js";
...
import { tool$countGuildScheduledEventUsers } from "./tools/countGuildScheduledEventUsers.js";
import { tool$createGuildScheduledEventException } from "./tools/createGuildScheduledEventException.js";
import { tool$createInteractionResponse } from "./tools/createInteractionResponse.js";
...
import { tool$deleteGuildScheduledEventException } from "./tools/deleteGuildScheduledEventException.js";
import { tool$deleteLobby } from "./tools/deleteLobby.js";
...
import { tool$getGuildJoinRequests } from "./tools/getGuildJoinRequests.js";
import { tool$getInviteTargetUsers } from "./tools/getInviteTargetUsers.js";
import { tool$getInviteTargetUsersJobStatus } from "./tools/getInviteTargetUsersJobStatus.js";
import { tool$guildRoleMemberCounts } from "./tools/guildRoleMemberCounts.js";
...
import { tool$guildSearch } from "./tools/guildSearch.js";
...
import { tool$guildsGetWidget } from "./tools/guildsGetWidget.js";
import { tool$guildsGetWidgetPng } from "./tools/guildsGetWidgetPng.js";
...
import { tool$guildsUpdateIncidentActions } from "./tools/guildsUpdateIncidentActions.js";
...
import { tool$guildTemplatesGet } from "./tools/guildTemplatesGet.js";
...
import { tool$invitesGet } from "./tools/invitesGet.js";
import { tool$listGuildScheduledEventExceptionUsers } from "./tools/listGuildScheduledEventExceptionUsers.js";
...
import { tool$removeInviteTargetUser } from "./tools/removeInviteTargetUser.js";
...
import { tool$stickersListPacks } from "./tools/stickersListPacks.js";
import { tool$stickersUpdateGuildSticker } from "./tools/stickersUpdateGuildSticker.js";
import { tool$updateGuildScheduledEventException } from "./tools/updateGuildScheduledEventException.js";
import { tool$updateInviteTargetUsers } from "./tools/updateInviteTargetUsers.js";
import { tool$updateLobbyMessageExternalModerationMetadata } from "./tools/updateLobbyMessageExternalModerationMetadata.js";
import { tool$updateUserMessageExternalModerationMetadata } from "./tools/updateUserMessageExternalModerationMetadata.js";
import { tool$updateVoiceChannelStatus } from "./tools/updateVoiceChannelStatus.js";
...
import { tool$webhooksDeleteMessage } from "./tools/webhooksDeleteMessage.js";
import { tool$webhooksDeleteOriginalMessage } from "./tools/webhooksDeleteOriginalMessage.js";
import { tool$webhooksDeleteWithToken } from "./tools/webhooksDeleteWithToken.js";
import { tool$webhooksExecute } from "./tools/webhooksExecute.js";
import { tool$webhooksExecuteGithub } from "./tools/webhooksExecuteGithub.js";
import { tool$webhooksExecuteSlack } from "./tools/webhooksExecuteSlack.js";
import { tool$webhooksGet } from "./tools/webhooksGet.js";
import { tool$webhooksGetMessage } from "./tools/webhooksGetMessage.js";
import { tool$webhooksGetOriginalMessage } from "./tools/webhooksGetOriginalMessage.js";
import { tool$webhooksGetWithToken } from "./tools/webhooksGetWithToken.js";
...
import { tool$webhooksUpdateMessageForm } from "./tools/webhooksUpdateMessageForm.js";
import { tool$webhooksUpdateMessageJson } from "./tools/webhooksUpdateMessageJson.js";
import { tool$webhooksUpdateMessageMultipart } from "./tools/webhooksUpdateMessageMultipart.js";
import { tool$webhooksUpdateOriginalMessageForm } from "./tools/webhooksUpdateOriginalMessageForm.js";
import { tool$webhooksUpdateOriginalMessageJson } from "./tools/webhooksUpdateOriginalMessageJson.js";
import { tool$webhooksUpdateOriginalMessageMultipart } from "./tools/webhooksUpdateOriginalMessageMultipart.js";
import { tool$webhooksUpdateWithToken } from "./tools/webhooksUpdateWithToken.js";
...
export function createMCPServer(deps: {
  ...
  tool(tool$createPin);
  tool(tool$deletePin);
  tool(tool$updateVoiceChannelStatus);
  tool(tool$guildSearch);
  tool(tool$getGuildJoinRequests);
  tool(tool$actionGuildJoinRequest);
  tool(tool$guildRoleMemberCounts);
  tool(tool$createGuildScheduledEventException);
  tool(tool$deleteGuildScheduledEventException);
  tool(tool$updateGuildScheduledEventException);
  tool(tool$countGuildScheduledEventUsers);
  tool(tool$listGuildScheduledEventExceptionUsers);
  tool(tool$createInteractionResponse);
  tool(tool$getInviteTargetUsers);
  tool(tool$updateInviteTargetUsers);
  tool(tool$bulkAddInviteTargetUsers);
  tool(tool$bulkRemoveInviteTargetUsers);
  tool(tool$getInviteTargetUsersJobStatus);
  tool(tool$addInviteTargetUser);
  tool(tool$removeInviteTargetUser);
  tool(tool$deleteLobby);
  tool(tool$bulkUpdateLobbyMembers);
  tool(tool$createLinkedLobbyGuildInviteForUser);
  tool(tool$updateLobbyMessageExternalModerationMetadata);
  tool(tool$updateUserMessageExternalModerationMetadata);
  ...
  tool(tool$applicationsGetGateway);
  tool(tool$applicationsGetBotGateway);
  tool(tool$applicationsGetOAuth2Me);
  tool(tool$applicationsGetPublicKeys);
  tool(tool$applicationsPartnerSDKUnmergeProvisionalAccount);
  tool(tool$applicationsPartnerSDKToken);
  ...
  tool(tool$webhooksGetWithToken);
  tool(tool$webhooksExecute);
  tool(tool$webhooksDeleteWithToken);
  tool(tool$webhooksUpdateWithToken);
  tool(tool$webhooksExecuteGithub);
  tool(tool$webhooksGetOriginalMessage);
  tool(tool$webhooksDeleteOriginalMessage);
  tool(tool$webhooksUpdateOriginalMessageJson);
  tool(tool$webhooksUpdateOriginalMessageForm);
  tool(tool$webhooksUpdateOriginalMessageMultipart);
  tool(tool$webhooksGetMessage);
  tool(tool$webhooksDeleteMessage);
  tool(tool$webhooksUpdateMessageJson);
  tool(tool$webhooksUpdateMessageForm);
  tool(tool$webhooksUpdateMessageMultipart);
  tool(tool$webhooksExecuteSlack);
  tool(tool$guildTemplatesGet);
  ...
  tool(tool$guildsUpdateIncidentActions);
  ...
  tool(tool$guildsGetWidget);
  tool(tool$guildsGetWidgetPng);
