...
const args = {
  request: operations.CreateThreadFormRequest$inboundSchema,
};

export const tool$channelsStartThreadForm: ToolDefinition<typeof args> = {
  name: "channels-start-thread-form",
  description:
  ...
  tool: async (client, args, ctx) => {
    const [result, apiCall] = await channelsStartThreadForm(
      client,
      args.request,
