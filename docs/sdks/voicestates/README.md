...
async function run() {
  const result = await discord.guilds.voiceStates.getSelf({
    guildId: "<value>",
  });
...
import { guildsVoiceStatesGetSelf } from "@ryan.blunden/discord-sdk/funcs/guildsVoiceStatesGetSelf.js";
...
async function run() {
  const res = await guildsVoiceStatesGetSelf(discord, {
    guildId: "<value>",
  });
...
async function run() {
  await discord.guilds.voiceStates.updateSelf({
    guildId: "<value>",
    requestBody: {},
  });
...
```typescript
import { DiscordCore } from "@ryan.blunden/discord-sdk/core.js";
import { guildsVoiceStatesUpdateSelf } from "@ryan.blunden/discord-sdk/funcs/guildsVoiceStatesUpdateSelf.js";
...
async function run() {
  const res = await guildsVoiceStatesUpdateSelf(discord, {
    guildId: "<value>",
    requestBody: {},
  });
...
async function run() {
  await discord.guilds.voiceStates.update({
    guildId: "<value>",
    userId: "<value>",
    requestBody: {},
  });
...
```typescript
import { DiscordCore } from "@ryan.blunden/discord-sdk/core.js";
import { guildsVoiceStatesUpdate } from "@ryan.blunden/discord-sdk/funcs/guildsVoiceStatesUpdate.js";
...
async function run() {
  const res = await guildsVoiceStatesUpdate(discord, {
    guildId: "<value>",
    userId: "<value>",
    requestBody: {},
  });
