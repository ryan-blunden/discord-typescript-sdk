...
async function run() {
  const result = await discord.voiceStates.getSelf({
    guildId: "<value>",
  });
...
import { voiceStatesGetSelf } from "discord-sdk/funcs/voiceStatesGetSelf.js";
...
async function run() {
  const res = await voiceStatesGetSelf(discord, {
    guildId: "<value>",
  });
...
async function run() {
  const result = await discord.voiceStates.getForUser({
    guildId: "<value>",
    userId: "<value>",
  });
...
```typescript
import { DiscordCore } from "discord-sdk/core.js";
import { voiceStatesGetForUser } from "discord-sdk/funcs/voiceStatesGetForUser.js";
...
async function run() {
  const res = await voiceStatesGetForUser(discord, {
    guildId: "<value>",
    userId: "<value>",
  });
...
async function run() {
  await discord.voiceStates.update({
    guildId: "<value>",
    userId: "<value>",
    requestBody: {},
  });
...
```typescript
import { DiscordCore } from "discord-sdk/core.js";
import { voiceStatesUpdate } from "discord-sdk/funcs/voiceStatesUpdate.js";
...
async function run() {
  const res = await voiceStatesUpdate(discord, {
    guildId: "<value>",
    userId: "<value>",
    requestBody: {},
  });
