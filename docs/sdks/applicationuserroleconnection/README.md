...
async function run() {
  const result = await discord.applicationUserRoleConnection.update({
    applicationId: "<value>",
    requestBody: {},
  });
...
import { applicationUserRoleConnectionUpdate } from "@ryan.blunden/discord-sdk/funcs/applicationUserRoleConnectionUpdate.js";
...
async function run() {
  const res = await applicationUserRoleConnectionUpdate(discord, {
    applicationId: "<value>",
    requestBody: {},
  });
