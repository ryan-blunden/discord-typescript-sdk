...
async function run() {
  await discord.channelPermissions.deleteOverwrite({
    channelId: "<value>",
    overwriteId: "<value>",
  });
...
import { channelPermissionsDeleteOverwrite } from "@ryan.blunden/discord-sdk/funcs/channelPermissionsDeleteOverwrite.js";
...
async function run() {
  const res = await channelPermissionsDeleteOverwrite(discord, {
    channelId: "<value>",
    overwriteId: "<value>",
  });
