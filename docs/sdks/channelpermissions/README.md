...
async function run() {
  await discord.channelPermissions.setOverwrite({
    channelId: "<value>",
    overwriteId: "<value>",
    requestBody: {},
  });
...
import { channelPermissionsSetOverwrite } from "@ryan.blunden/discord-sdk/funcs/channelPermissionsSetOverwrite.js";
...
async function run() {
  const res = await channelPermissionsSetOverwrite(discord, {
    channelId: "<value>",
    overwriteId: "<value>",
    requestBody: {},
  });
