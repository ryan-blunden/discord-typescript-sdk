...
async function run() {
  const result = await discord.autoModerationRules.get({
    guildId: "<value>",
    ruleId: "<value>",
  });
...
import { autoModerationRulesGet } from "@ryan.blunden/discord-sdk/funcs/autoModerationRulesGet.js";
...
async function run() {
  const res = await autoModerationRulesGet(discord, {
    guildId: "<value>",
    ruleId: "<value>",
  });
...
async function run() {
  await discord.autoModerationRules.delete({
    guildId: "<value>",
    ruleId: "<value>",
  });
...
```typescript
import { DiscordCore } from "@ryan.blunden/discord-sdk/core.js";
import { autoModerationRulesDelete } from "@ryan.blunden/discord-sdk/funcs/autoModerationRulesDelete.js";
...
async function run() {
  const res = await autoModerationRulesDelete(discord, {
    guildId: "<value>",
    ruleId: "<value>",
  });
...
async function run() {
  const result = await discord.autoModerationRules.create({
    guildId: "<value>",
    requestBody: {
      name: "<value>",
    },
...
```typescript
import { DiscordCore } from "@ryan.blunden/discord-sdk/core.js";
import { autoModerationRulesCreate } from "@ryan.blunden/discord-sdk/funcs/autoModerationRulesCreate.js";
...
async function run() {
  const res = await autoModerationRulesCreate(discord, {
    guildId: "<value>",
    requestBody: {
      name: "<value>",
    },
