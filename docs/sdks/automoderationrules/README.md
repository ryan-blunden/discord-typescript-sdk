...
async function run() {
  const result = await discord.autoModerationRules.createRule({
    guildId: "<value>",
    requestBody: {
      name: "<value>",
    },
...
import { autoModerationRulesCreateRule } from "@ryan.blunden/discord-sdk/funcs/autoModerationRulesCreateRule.js";
...
async function run() {
  const res = await autoModerationRulesCreateRule(discord, {
    guildId: "<value>",
    requestBody: {
      name: "<value>",
      triggerMetadata: {},
