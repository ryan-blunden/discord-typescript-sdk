...
async function run() {
  const result = await discord.guildMembers.get({
    guildId: "<value>",
    userId: "<value>",
  });
...
import { guildMembersGet } from "@ryan.blunden/discord-sdk/funcs/guildMembersGet.js";
...
async function run() {
  const res = await guildMembersGet(discord, {
    guildId: "<value>",
    userId: "<value>",
  });
...
async function run() {
  const result = await discord.guildMembers.add({
    guildId: "<value>",
    userId: "<value>",
    requestBody: {
      accessToken: "<value>",
...
```typescript
import { DiscordCore } from "@ryan.blunden/discord-sdk/core.js";
import { guildMembersAdd } from "@ryan.blunden/discord-sdk/funcs/guildMembersAdd.js";
...
async function run() {
  const res = await guildMembersAdd(discord, {
    guildId: "<value>",
    userId: "<value>",
    requestBody: {
      accessToken: "<value>",
