...
* [sync](#sync) - Syncs the template to the guild's current state. Requires the MANAGE_GUILD permission. Returns the guild template object on success.
* [delete](#delete) - Deletes the template. Requires the MANAGE_GUILD permission. Returns the deleted guild template object on success.
* [update](#update) - Modifies the template's metadata. Requires the MANAGE_GUILD permission. Returns the guild template object on success.
...
import { guildTemplatesGet } from "@ryan.blunden/discord-sdk/funcs/guildTemplatesGet.js";
...
async function run() {
  ...
  if (res.ok) {
    ...
    console.log("guildTemplatesGet failed:", res.error);
  }
}
...
async function run() {
  const result = await discord.guildTemplates.getNewMemberWelcome({
    guildId: "<value>",
  });
...
```typescript
import { DiscordCore } from "@ryan.blunden/discord-sdk/core.js";
import { guildTemplatesGetNewMemberWelcome } from "@ryan.blunden/discord-sdk/funcs/guildTemplatesGetNewMemberWelcome.js";
...
async function run() {
  const res = await guildTemplatesGetNewMemberWelcome(discord, {
    guildId: "<value>",
  });
  if (res.ok) {
    const { value: result } = res;
    ...
    console.log("guildTemplatesGetNewMemberWelcome failed:", res.error);
  }
}
...
async function run() {
  const result = await discord.guildTemplates.list({
    guildId: "<value>",
  });
...
```typescript
import { DiscordCore } from "@ryan.blunden/discord-sdk/core.js";
import { guildTemplatesList } from "@ryan.blunden/discord-sdk/funcs/guildTemplatesList.js";
...
async function run() {
  const res = await guildTemplatesList(discord, {
    guildId: "<value>",
  });
  if (res.ok) {
    const { value: result } = res;
    ...
    console.log("guildTemplatesList failed:", res.error);
  }
}
...
async function run() {
  const result = await discord.guildTemplates.create({
    guildId: "<value>",
    requestBody: {
      name: "<value>",
    },
...
```typescript
import { DiscordCore } from "@ryan.blunden/discord-sdk/core.js";
import { guildTemplatesCreate } from "@ryan.blunden/discord-sdk/funcs/guildTemplatesCreate.js";
...
async function run() {
  const res = await guildTemplatesCreate(discord, {
    guildId: "<value>",
    requestBody: {
      name: "<value>",
    },
  ...
  if (res.ok) {
    ...
    console.log("guildTemplatesCreate failed:", res.error);
  }
}
...
async function run() {
  const result = await discord.guildTemplates.sync({
    guildId: "<value>",
    code: "<value>",
  });
...
```typescript
import { DiscordCore } from "@ryan.blunden/discord-sdk/core.js";
import { guildTemplatesSync } from "@ryan.blunden/discord-sdk/funcs/guildTemplatesSync.js";
...
async function run() {
  const res = await guildTemplatesSync(discord, {
    guildId: "<value>",
    code: "<value>",
  });
  if (res.ok) {
    ...
    console.log("guildTemplatesSync failed:", res.error);
  }
}
...
async function run() {
  const result = await discord.guildTemplates.delete({
    guildId: "<value>",
    code: "<value>",
  });
...
```typescript
import { DiscordCore } from "@ryan.blunden/discord-sdk/core.js";
import { guildTemplatesDelete } from "@ryan.blunden/discord-sdk/funcs/guildTemplatesDelete.js";
...
async function run() {
  const res = await guildTemplatesDelete(discord, {
    guildId: "<value>",
    code: "<value>",
  });
  if (res.ok) {
    ...
    console.log("guildTemplatesDelete failed:", res.error);
  }
}
...
| Parameter                                                                                                                                                                      | Type                                                                                                                                                                           | Required                                                                                                                                                                       | Description                                                                                                                                                                    |
| ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| `request`                                                                                                                                                                      | [operations.DeleteGuildTemplateRequest](../../models/operations/deleteguildtemplaterequest.md)                                                                                 | :heavy_check_mark:                                                                                                                                                             | The request object to use for the request.                                                                                                                                     |
| `options`                                                                                                                                                                      | RequestOptions                                                                                                                                                                 | :heavy_minus_sign:                                                                                                                                                             | Used to set various options for making HTTP requests.                                                                                                                          |
| `options.fetchOptions`                                                                                                                                                         | [RequestInit](https://developer.mozilla.org/en-US/docs/Web/API/Request/Request#options)                                                                                        | :heavy_minus_sign:                                                                                                                                                             | Options that are passed to the underlying HTTP request. This can be used to inject extra headers for examples. All `Request` options, except `method` and `body`, are allowed. |
| `options.retries`                                                                                                                                                              | [RetryConfig](../../lib/utils/retryconfig.md)                                                                                                                                  | :heavy_minus_sign:                                                                                                                                                             | Enables retrying HTTP requests under certain failure conditions.                                                                                                               |
...
async function run() {
  const result = await discord.guildTemplates.update({
    guildId: "<value>",
    code: "<value>",
    requestBody: {},
  });
...
```typescript
import { DiscordCore } from "@ryan.blunden/discord-sdk/core.js";
import { guildTemplatesUpdate } from "@ryan.blunden/discord-sdk/funcs/guildTemplatesUpdate.js";
...
async function run() {
  const res = await guildTemplatesUpdate(discord, {
    guildId: "<value>",
    code: "<value>",
    requestBody: {},
  });
  if (res.ok) {
    ...
    console.log("guildTemplatesUpdate failed:", res.error);
  }
}
