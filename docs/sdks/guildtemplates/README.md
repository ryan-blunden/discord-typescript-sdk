...
async function run() {
  const result = await discord.guildTemplates.createFromCode({
    code: "<value>",
    requestBody: {
      name: "<value>",
    },
...
import { guildTemplatesCreateFromCode } from "@ryan.blunden/discord-sdk/funcs/guildTemplatesCreateFromCode.js";
...
async function run() {
  const res = await guildTemplatesCreateFromCode(discord, {
    code: "<value>",
    requestBody: {
      name: "<value>",
    },
