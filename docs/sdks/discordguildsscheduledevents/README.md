...
async function run() {
  const result = await discord.guilds.scheduledEvents.get({
    guildId: "<value>",
...
import { guildsScheduledEventsGet } from "@ryan.blunden/discord-sdk/funcs/guildsScheduledEventsGet.js";
...
async function run() {
  const res = await guildsScheduledEventsGet(discord, {
    guildId: "<value>",
    guildScheduledEventId: "<value>",
  });
...
async function run() {
  const result = await discord.guilds.scheduledEvents.list({
    guildId: "<value>",
  });
...
```typescript
import { DiscordCore } from "@ryan.blunden/discord-sdk/core.js";
import { guildsScheduledEventsList } from "@ryan.blunden/discord-sdk/funcs/guildsScheduledEventsList.js";
...
async function run() {
  const res = await guildsScheduledEventsList(discord, {
    guildId: "<value>",
  });
...
async function run() {
  const result = await discord.guilds.scheduledEvents.update({
    guildId: "<value>",
    guildScheduledEventId: "<value>",
    requestBody: {},
  });
...
```typescript
import { DiscordCore } from "@ryan.blunden/discord-sdk/core.js";
import { guildsScheduledEventsUpdate } from "@ryan.blunden/discord-sdk/funcs/guildsScheduledEventsUpdate.js";
...
async function run() {
  const res = await guildsScheduledEventsUpdate(discord, {
    guildId: "<value>",
    guildScheduledEventId: "<value>",
    requestBody: {},
  });
