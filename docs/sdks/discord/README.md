...
* [partnerSDKUnmergeProvisionalAccount](#partnersdkunmergeprovisionalaccount)
* [partnerSDKToken](#partnersdktoken)
* [createOrJoinLobby](#createorjoinlobby)
* [createLobby](#createlobby)
* [threadSearch](#threadsearch)
* [leaveLobby](#leavelobby)
* [editLobbyChannelLink](#editlobbychannellink)
* [createLobbyMessage](#createlobbymessage)
* [addLobbyMember](#addlobbymember)
* [deleteLobbyMember](#deletelobbymember)
* [getLobby](#getlobby)
* [editLobby](#editlobby)
...
async function run() {
  const result = await discord.partnerSDKToken({
    clientId: "<value>",
    externalAuthToken: "<value>",
  });
...
```typescript
import { DiscordCore } from "@ryan.blunden/discord-sdk/core.js";
import { partnerSDKToken } from "@ryan.blunden/discord-sdk/funcs/partnerSDKToken.js";
...
async function run() {
  const res = await partnerSDKToken(discord, {
    clientId: "<value>",
    externalAuthToken: "<value>",
  });
...
async function run() {
  const result = await discord.createOrJoinLobby({
...
```typescript
import { DiscordCore } from "@ryan.blunden/discord-sdk/core.js";
import { createOrJoinLobby } from "@ryan.blunden/discord-sdk/funcs/createOrJoinLobby.js";
...
async function run() {
  const res = await createOrJoinLobby(discord, {
    botToken: process.env["DISCORD_BOT_TOKEN"] ?? "",
  }, {
    secret: "<value>",
  });
...
```typescript
import { DiscordCore } from "@ryan.blunden/discord-sdk/core.js";
import { createLobby } from "@ryan.blunden/discord-sdk/funcs/createLobby.js";
...
async function run() {
  const res = await createLobby(discord, {});
...
```typescript
import { DiscordCore } from "@ryan.blunden/discord-sdk/core.js";
import { leaveLobby } from "@ryan.blunden/discord-sdk/funcs/leaveLobby.js";
...
async function run() {
  const res = await leaveLobby(discord, {
    botToken: process.env["DISCORD_BOT_TOKEN"] ?? "",
  }, {
    lobbyId: "<value>",
  });
...
async function run() {
  const result = await discord.editLobbyChannelLink({
    botToken: process.env["DISCORD_BOT_TOKEN"] ?? "",
  }, {
    lobbyId: "<value>",
    requestBody: {},
...
```typescript
import { DiscordCore } from "@ryan.blunden/discord-sdk/core.js";
import { editLobbyChannelLink } from "@ryan.blunden/discord-sdk/funcs/editLobbyChannelLink.js";
...
async function run() {
  const res = await editLobbyChannelLink(discord, {
    botToken: process.env["DISCORD_BOT_TOKEN"] ?? "",
  }, {
    lobbyId: "<value>",
    requestBody: {},
...
async function run() {
  const result = await discord.createLobbyMessage({
    botToken: process.env["DISCORD_BOT_TOKEN"] ?? "",
  }, {
    lobbyId: "<value>",
    sdkMessageRequest: {},
...
```typescript
import { DiscordCore } from "@ryan.blunden/discord-sdk/core.js";
import { createLobbyMessage } from "@ryan.blunden/discord-sdk/funcs/createLobbyMessage.js";
...
async function run() {
  const res = await createLobbyMessage(discord, {
    botToken: process.env["DISCORD_BOT_TOKEN"] ?? "",
  }, {
    lobbyId: "<value>",
    sdkMessageRequest: {},
...
async function run() {
  const result = await discord.addLobbyMember({
    lobbyId: "<value>",
    userId: "<value>",
    requestBody: {},
  });
...
```typescript
import { DiscordCore } from "@ryan.blunden/discord-sdk/core.js";
import { addLobbyMember } from "@ryan.blunden/discord-sdk/funcs/addLobbyMember.js";
...
async function run() {
  const res = await addLobbyMember(discord, {
    lobbyId: "<value>",
    userId: "<value>",
    requestBody: {},
  });
...
async function run() {
  await discord.deleteLobbyMember({
    lobbyId: "<value>",
    userId: "<value>",
  });
...
```typescript
import { DiscordCore } from "@ryan.blunden/discord-sdk/core.js";
import { deleteLobbyMember } from "@ryan.blunden/discord-sdk/funcs/deleteLobbyMember.js";
...
async function run() {
  const res = await deleteLobbyMember(discord, {
    lobbyId: "<value>",
    userId: "<value>",
  });
...
async function run() {
  const result = await discord.getLobby({
    lobbyId: "<value>",
  });
...
```typescript
import { DiscordCore } from "@ryan.blunden/discord-sdk/core.js";
import { getLobby } from "@ryan.blunden/discord-sdk/funcs/getLobby.js";
...
async function run() {
  const res = await getLobby(discord, {
    lobbyId: "<value>",
  });
...
async function run() {
  const result = await discord.editLobby({
    lobbyId: "<value>",
    requestBody: {},
  });
...
```typescript
import { DiscordCore } from "@ryan.blunden/discord-sdk/core.js";
import { editLobby } from "@ryan.blunden/discord-sdk/funcs/editLobby.js";
...
async function run() {
  const res = await editLobby(discord, {
    lobbyId: "<value>",
    requestBody: {},
  });
