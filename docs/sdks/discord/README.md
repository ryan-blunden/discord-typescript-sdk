...
* [bulkAddInviteTargetUsers](#bulkaddinvitetargetusers) - Add multiple target users to an existing invite.
* [bulkRemoveInviteTargetUsers](#bulkremoveinvitetargetusers) - Remove multiple target users from an existing invite.
* [getInviteTargetUsersJobStatus](#getinvitetargetusersjobstatus) - Get the target users job status for an invite.
* [addInviteTargetUser](#addinvitetargetuser) - Add a target user to an existing invite.
* [removeInviteTargetUser](#removeinvitetargetuser) - Remove a target user from an existing invite.
...
## bulkAddInviteTargetUsers

Add multiple target users to an existing invite.

### Example Usage

<!-- UsageSnippet language="typescript" operationID="bulk_add_invite_target_users" method="post" path="/invites/{code}/target-users/bulk-add" -->
```typescript
import { Discord } from "@ryan.blunden/discord-sdk";
...
async function run() {
  const result = await discord.bulkAddInviteTargetUsers({
    code: "<value>",
    requestBody: {
      userIds: [
        "<value 1>",
...
```typescript
import { DiscordCore } from "@ryan.blunden/discord-sdk/core.js";
import { bulkAddInviteTargetUsers } from "@ryan.blunden/discord-sdk/funcs/bulkAddInviteTargetUsers.js";
...
async function run() {
  const res = await bulkAddInviteTargetUsers(discord, {
    code: "<value>",
    requestBody: {
      userIds: [
        "<value 1>",
  ...
  if (res.ok) {
    ...
    console.log("bulkAddInviteTargetUsers failed:", res.error);
  }
}
...
| Parameter                                                                                                                                                                      | Type                                                                                                                                                                           | Required                                                                                                                                                                       | Description                                                                                                                                                                    |
| ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| `request`                                                                                                                                                                      | [operations.BulkAddInviteTargetUsersRequest](../../models/operations/bulkaddinvitetargetusersrequest.md)                                                                       | :heavy_check_mark:                                                                                                                                                             | The request object to use for the request.                                                                                                                                     |
| `options`                                                                                                                                                                      | RequestOptions                                                                                                                                                                 | :heavy_minus_sign:                                                                                                                                                             | Used to set various options for making HTTP requests.                                                                                                                          |
| `options.fetchOptions`                                                                                                                                                         | [RequestInit](https://developer.mozilla.org/en-US/docs/Web/API/Request/Request#options)                                                                                        | :heavy_minus_sign:                                                                                                                                                             | Options that are passed to the underlying HTTP request. This can be used to inject extra headers for examples. All `Request` options, except `method` and `body`, are allowed. |
| `options.retries`                                                                                                                                                              | [RetryConfig](../../lib/utils/retryconfig.md)                                                                                                                                  | :heavy_minus_sign:                                                                                                                                                             | Enables retrying HTTP requests under certain failure conditions.                                                                                                               |
...
**Promise\<[operations.BulkAddInviteTargetUsersResponse](../../models/operations/bulkaddinvitetargetusersresponse.md)\>**
...
## bulkRemoveInviteTargetUsers

Remove multiple target users from an existing invite.

### Example Usage

<!-- UsageSnippet language="typescript" operationID="bulk_remove_invite_target_users" method="post" path="/invites/{code}/target-users/bulk-delete" -->
```typescript
import { Discord } from "@ryan.blunden/discord-sdk";
...
async function run() {
  const result = await discord.bulkRemoveInviteTargetUsers({
    code: "<value>",
    requestBody: {
      userIds: [
        "<value 1>",
...
```typescript
import { DiscordCore } from "@ryan.blunden/discord-sdk/core.js";
import { bulkRemoveInviteTargetUsers } from "@ryan.blunden/discord-sdk/funcs/bulkRemoveInviteTargetUsers.js";
...
async function run() {
  const res = await bulkRemoveInviteTargetUsers(discord, {
    code: "<value>",
    requestBody: {
      userIds: [
        "<value 1>",
  ...
  if (res.ok) {
    ...
    console.log("bulkRemoveInviteTargetUsers failed:", res.error);
  }
}
...
| Parameter                                                                                                                                                                      | Type                                                                                                                                                                           | Required                                                                                                                                                                       | Description                                                                                                                                                                    |
| ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| `request`                                                                                                                                                                      | [operations.BulkRemoveInviteTargetUsersRequest](../../models/operations/bulkremoveinvitetargetusersrequest.md)                                                                 | :heavy_check_mark:                                                                                                                                                             | The request object to use for the request.                                                                                                                                     |
| `options`                                                                                                                                                                      | RequestOptions                                                                                                                                                                 | :heavy_minus_sign:                                                                                                                                                             | Used to set various options for making HTTP requests.                                                                                                                          |
| `options.fetchOptions`                                                                                                                                                         | [RequestInit](https://developer.mozilla.org/en-US/docs/Web/API/Request/Request#options)                                                                                        | :heavy_minus_sign:                                                                                                                                                             | Options that are passed to the underlying HTTP request. This can be used to inject extra headers for examples. All `Request` options, except `method` and `body`, are allowed. |
| `options.retries`                                                                                                                                                              | [RetryConfig](../../lib/utils/retryconfig.md)                                                                                                                                  | :heavy_minus_sign:                                                                                                                                                             | Enables retrying HTTP requests under certain failure conditions.                                                                                                               |
...
**Promise\<[operations.BulkRemoveInviteTargetUsersResponse](../../models/operations/bulkremoveinvitetargetusersresponse.md)\>**
...
<!-- UsageSnippet language="typescript" operationID="add_invite_target_user" method="put" path="/invites/{code}/target-users/{user_id}" -->
```typescript
import { Discord } from "@ryan.blunden/discord-sdk";
...
async function run() {
  const result = await discord.addInviteTargetUser({
    code: "<value>",
    userId: "<value>",
  });
...
```typescript
import { DiscordCore } from "@ryan.blunden/discord-sdk/core.js";
import { addInviteTargetUser } from "@ryan.blunden/discord-sdk/funcs/addInviteTargetUser.js";
...
async function run() {
  const res = await addInviteTargetUser(discord, {
    code: "<value>",
    userId: "<value>",
  });
  if (res.ok) {
    ...
    console.log("addInviteTargetUser failed:", res.error);
  }
}
...
| Parameter                                                                                                                                                                      | Type                                                                                                                                                                           | Required                                                                                                                                                                       | Description                                                                                                                                                                    |
| ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| `request`                                                                                                                                                                      | [operations.AddInviteTargetUserRequest](../../models/operations/addinvitetargetuserrequest.md)                                                                                 | :heavy_check_mark:                                                                                                                                                             | The request object to use for the request.                                                                                                                                     |
| `options`                                                                                                                                                                      | RequestOptions                                                                                                                                                                 | :heavy_minus_sign:                                                                                                                                                             | Used to set various options for making HTTP requests.                                                                                                                          |
| `options.fetchOptions`                                                                                                                                                         | [RequestInit](https://developer.mozilla.org/en-US/docs/Web/API/Request/Request#options)                                                                                        | :heavy_minus_sign:                                                                                                                                                             | Options that are passed to the underlying HTTP request. This can be used to inject extra headers for examples. All `Request` options, except `method` and `body`, are allowed. |
| `options.retries`                                                                                                                                                              | [RetryConfig](../../lib/utils/retryconfig.md)                                                                                                                                  | :heavy_minus_sign:                                                                                                                                                             | Enables retrying HTTP requests under certain failure conditions.                                                                                                               |
...
**Promise\<[operations.AddInviteTargetUserResponse](../../models/operations/addinvitetargetuserresponse.md)\>**
...
## removeInviteTargetUser

Remove a target user from an existing invite.

### Example Usage

<!-- UsageSnippet language="typescript" operationID="remove_invite_target_user" method="delete" path="/invites/{code}/target-users/{user_id}" -->
```typescript
import { Discord } from "@ryan.blunden/discord-sdk";
...
async function run() {
  const result = await discord.removeInviteTargetUser({
    code: "<value>",
    userId: "<value>",
  });
...
```typescript
import { DiscordCore } from "@ryan.blunden/discord-sdk/core.js";
import { removeInviteTargetUser } from "@ryan.blunden/discord-sdk/funcs/removeInviteTargetUser.js";
...
async function run() {
  const res = await removeInviteTargetUser(discord, {
    code: "<value>",
    userId: "<value>",
  });
  if (res.ok) {
    ...
    console.log("removeInviteTargetUser failed:", res.error);
  }
}
...
| Parameter                                                                                                                                                                      | Type                                                                                                                                                                           | Required                                                                                                                                                                       | Description                                                                                                                                                                    |
| ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| `request`                                                                                                                                                                      | [operations.RemoveInviteTargetUserRequest](../../models/operations/removeinvitetargetuserrequest.md)                                                                           | :heavy_check_mark:                                                                                                                                                             | The request object to use for the request.                                                                                                                                     |
| `options`                                                                                                                                                                      | RequestOptions                                                                                                                                                                 | :heavy_minus_sign:                                                                                                                                                             | Used to set various options for making HTTP requests.                                                                                                                          |
| `options.fetchOptions`                                                                                                                                                         | [RequestInit](https://developer.mozilla.org/en-US/docs/Web/API/Request/Request#options)                                                                                        | :heavy_minus_sign:                                                                                                                                                             | Options that are passed to the underlying HTTP request. This can be used to inject extra headers for examples. All `Request` options, except `method` and `body`, are allowed. |
| `options.retries`                                                                                                                                                              | [RetryConfig](../../lib/utils/retryconfig.md)                                                                                                                                  | :heavy_minus_sign:                                                                                                                                                             | Enables retrying HTTP requests under certain failure conditions.                                                                                                               |
...
**Promise\<[operations.RemoveInviteTargetUserResponse](../../models/operations/removeinvitetargetuserresponse.md)\>**
