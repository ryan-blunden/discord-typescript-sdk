...
async function run() {
  const result = await discord.guildStickers.get({
    guildId: "<value>",
    stickerId: "<value>",
  });
...
import { guildStickersGet } from "@ryan.blunden/discord-sdk/funcs/guildStickersGet.js";
...
async function run() {
  const res = await guildStickersGet(discord, {
    guildId: "<value>",
    stickerId: "<value>",
  });
...
async function run() {
  const result = await discord.guildStickers.create({
    guildId: "<value>",
    requestBody: {
      file: "<value>",
      name: "<value>",
...
```typescript
import { DiscordCore } from "@ryan.blunden/discord-sdk/core.js";
import { guildStickersCreate } from "@ryan.blunden/discord-sdk/funcs/guildStickersCreate.js";
...
async function run() {
  const res = await guildStickersCreate(discord, {
    guildId: "<value>",
    requestBody: {
      file: "<value>",
      name: "<value>",
...
async function run() {
  const result = await discord.guildStickers.update({
    guildId: "<value>",
    stickerId: "<value>",
    requestBody: {},
  });
...
```typescript
import { DiscordCore } from "@ryan.blunden/discord-sdk/core.js";
import { guildStickersUpdate } from "@ryan.blunden/discord-sdk/funcs/guildStickersUpdate.js";
...
async function run() {
  const res = await guildStickersUpdate(discord, {
    guildId: "<value>",
    stickerId: "<value>",
    requestBody: {},
  });
