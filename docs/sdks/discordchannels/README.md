...
async function run() {
  await discord.guilds.channels.bulkUpdate({
    guildId: "<value>",
    requestBody: [
      {},
      {},
...
import { guildsChannelsBulkUpdate } from "@ryan.blunden/discord-sdk/funcs/guildsChannelsBulkUpdate.js";
...
async function run() {
  const res = await guildsChannelsBulkUpdate(discord, {
    guildId: "<value>",
    requestBody: [
      {},
      {},
