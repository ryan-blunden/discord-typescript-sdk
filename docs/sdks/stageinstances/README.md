...
import { stageInstancesCreate } from "@ryan.blunden/discord-sdk/funcs/stageInstancesCreate.js";
...
async function run() {
  ...
  if (res.ok) {
    ...
    console.log("stageInstancesCreate failed:", res.error);
  }
}
...
```typescript
import { DiscordCore } from "@ryan.blunden/discord-sdk/core.js";
import { stageInstancesGet } from "@ryan.blunden/discord-sdk/funcs/stageInstancesGet.js";
...
async function run() {
  ...
  if (res.ok) {
    ...
    console.log("stageInstancesGet failed:", res.error);
  }
}
...
```typescript
import { DiscordCore } from "@ryan.blunden/discord-sdk/core.js";
import { stageInstancesDelete } from "@ryan.blunden/discord-sdk/funcs/stageInstancesDelete.js";
...
```typescript
import { DiscordCore } from "@ryan.blunden/discord-sdk/core.js";
import { stageInstancesUpdate } from "@ryan.blunden/discord-sdk/funcs/stageInstancesUpdate.js";
...
async function run() {
  ...
  if (res.ok) {
    ...
    console.log("stageInstancesUpdate failed:", res.error);
  }
}
