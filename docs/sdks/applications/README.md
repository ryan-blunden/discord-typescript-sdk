...
* [updateMe](#updateme)
* [getGuildCommandPermissions](#getguildcommandpermissions)
* [setGuildCommandPermissions](#setguildcommandpermissions)
* [getUserRoleConnection](#getuserroleconnection)
...
* [getGuildCommand](#getguildcommand)
* [deleteGuildCommand](#deleteguildcommand)
* [listGuildCommands](#listguildcommands)
...
async function run() {
  const result = await discord.applications.getMyApplication();
...
import { applicationsGetMyApplication } from "discord-sdk/funcs/applicationsGetMyApplication.js";
...
async function run() {
  const res = await applicationsGetMyApplication(discord);
...
async function run() {
  const result = await discord.applications.updateMe({});
...
```typescript
import { DiscordCore } from "discord-sdk/core.js";
import { applicationsUpdateMe } from "discord-sdk/funcs/applicationsUpdateMe.js";
...
async function run() {
  const res = await applicationsUpdateMe(discord, {});
...
| Parameter                                                                                                                                                                      | Type                                                                                                                                                                           | Required                                                                                                                                                                       | Description                                                                                                                                                                    |
| ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| `request`                                                                                                                                                                      | [components.ApplicationFormPartial](../../models/components/applicationformpartial.md)                                                                                         | :heavy_check_mark:                                                                                                                                                             | The request object to use for the request.                                                                                                                                     |
| `options`                                                                                                                                                                      | RequestOptions                                                                                                                                                                 | :heavy_minus_sign:                                                                                                                                                             | Used to set various options for making HTTP requests.                                                                                                                          |
| `options.fetchOptions`                                                                                                                                                         | [RequestInit](https://developer.mozilla.org/en-US/docs/Web/API/Request/Request#options)                                                                                        | :heavy_minus_sign:                                                                                                                                                             | Options that are passed to the underlying HTTP request. This can be used to inject extra headers for examples. All `Request` options, except `method` and `body`, are allowed. |
| `options.retries`                                                                                                                                                              | [RetryConfig](../../lib/utils/retryconfig.md)                                                                                                                                  | :heavy_minus_sign:                                                                                                                                                             | Enables retrying HTTP requests under certain failure conditions.                                                                                                               |
...
async function run() {
  const result = await discord.applications.getGuildCommandPermissions({
    botToken: process.env["DISCORD_BOT_TOKEN"] ?? "",
  }, {
    applicationId: "<value>",
    guildId: "<value>",
...
```typescript
import { DiscordCore } from "discord-sdk/core.js";
import { applicationsGetGuildCommandPermissions } from "discord-sdk/funcs/applicationsGetGuildCommandPermissions.js";
...
async function run() {
  const res = await applicationsGetGuildCommandPermissions(discord, {
    botToken: process.env["DISCORD_BOT_TOKEN"] ?? "",
  }, {
    applicationId: "<value>",
    guildId: "<value>",
...
```typescript
import { DiscordCore } from "discord-sdk/core.js";
import { applicationsSetGuildCommandPermissions } from "discord-sdk/funcs/applicationsSetGuildCommandPermissions.js";
...
async function run() {
  const result = await discord.applications.getUserRoleConnection({
    applicationId: "<value>",
  });
...
```typescript
import { DiscordCore } from "discord-sdk/core.js";
import { applicationsGetUserRoleConnection } from "discord-sdk/funcs/applicationsGetUserRoleConnection.js";
...
async function run() {
  const res = await applicationsGetUserRoleConnection(discord, {
    applicationId: "<value>",
  });
...
```typescript
import { DiscordCore } from "discord-sdk/core.js";
import { applicationsDeleteUserRoleConnection } from "discord-sdk/funcs/applicationsDeleteUserRoleConnection.js";
...
```typescript
import { DiscordCore } from "discord-sdk/core.js";
import { applicationsUpdateRoleConnectionsMetadata } from "discord-sdk/funcs/applicationsUpdateRoleConnectionsMetadata.js";
...
```typescript
import { DiscordCore } from "discord-sdk/core.js";
import { applicationsConsumeEntitlement } from "discord-sdk/funcs/applicationsConsumeEntitlement.js";
...
async function run() {
  const result = await discord.applications.getGuildCommand({
    botToken: process.env["DISCORD_BOT_TOKEN"] ?? "",
  }, {
    applicationId: "<value>",
    guildId: "<value>",
...
```typescript
import { DiscordCore } from "discord-sdk/core.js";
import { applicationsGetGuildCommand } from "discord-sdk/funcs/applicationsGetGuildCommand.js";
...
async function run() {
  const res = await applicationsGetGuildCommand(discord, {
    botToken: process.env["DISCORD_BOT_TOKEN"] ?? "",
  }, {
    applicationId: "<value>",
    guildId: "<value>",
...
async function run() {
  await discord.applications.deleteGuildCommand({
    botToken: process.env["DISCORD_BOT_TOKEN"] ?? "",
  }, {
    applicationId: "<value>",
    guildId: "<value>",
...
```typescript
import { DiscordCore } from "discord-sdk/core.js";
import { applicationsDeleteGuildCommand } from "discord-sdk/funcs/applicationsDeleteGuildCommand.js";
...
async function run() {
  const res = await applicationsDeleteGuildCommand(discord, {
    botToken: process.env["DISCORD_BOT_TOKEN"] ?? "",
  }, {
    applicationId: "<value>",
    guildId: "<value>",
...
async function run() {
  const result = await discord.applications.listGuildCommands({
    botToken: process.env["DISCORD_BOT_TOKEN"] ?? "",
  }, {
    applicationId: "<value>",
    guildId: "<value>",
...
```typescript
import { DiscordCore } from "discord-sdk/core.js";
import { applicationsListGuildCommands } from "discord-sdk/funcs/applicationsListGuildCommands.js";
...
async function run() {
  const res = await applicationsListGuildCommands(discord, {
    botToken: process.env["DISCORD_BOT_TOKEN"] ?? "",
  }, {
    applicationId: "<value>",
    guildId: "<value>",
...
```typescript
import { DiscordCore } from "discord-sdk/core.js";
import { applicationsGetEntitlement } from "discord-sdk/funcs/applicationsGetEntitlement.js";
...
```typescript
import { DiscordCore } from "discord-sdk/core.js";
import { applicationsDeleteEntitlement } from "discord-sdk/funcs/applicationsDeleteEntitlement.js";
...
```typescript
import { DiscordCore } from "discord-sdk/core.js";
import { applicationsGetEntitlements } from "discord-sdk/funcs/applicationsGetEntitlements.js";
...
async function run() {
  const result = await discord.applications.updateCommand({
    botToken: process.env["DISCORD_BOT_TOKEN"] ?? "",
  }, {
    applicationId: "<value>",
    commandId: "<value>",
...
```typescript
import { DiscordCore } from "discord-sdk/core.js";
import { applicationsUpdateCommand } from "discord-sdk/funcs/applicationsUpdateCommand.js";
...
async function run() {
  const res = await applicationsUpdateCommand(discord, {
    botToken: process.env["DISCORD_BOT_TOKEN"] ?? "",
  }, {
    applicationId: "<value>",
    commandId: "<value>",
...
```typescript
import { DiscordCore } from "discord-sdk/core.js";
import { applicationsListCommands } from "discord-sdk/funcs/applicationsListCommands.js";
...
async function run() {
  await discord.applications.deleteEmoji({
    applicationId: "<value>",
    emojiId: "<value>",
  });
...
```typescript
import { DiscordCore } from "discord-sdk/core.js";
import { applicationsDeleteEmoji } from "discord-sdk/funcs/applicationsDeleteEmoji.js";
...
async function run() {
  const res = await applicationsDeleteEmoji(discord, {
    applicationId: "<value>",
    emojiId: "<value>",
  });
...
| Parameter                                                                                                                                                                      | Type                                                                                                                                                                           | Required                                                                                                                                                                       | Description                                                                                                                                                                    |
| ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| `request`                                                                                                                                                                      | [operations.DeleteApplicationEmojiRequest](../../models/operations/deleteapplicationemojirequest.md)                                                                           | :heavy_check_mark:                                                                                                                                                             | The request object to use for the request.                                                                                                                                     |
| `options`                                                                                                                                                                      | RequestOptions                                                                                                                                                                 | :heavy_minus_sign:                                                                                                                                                             | Used to set various options for making HTTP requests.                                                                                                                          |
| `options.fetchOptions`                                                                                                                                                         | [RequestInit](https://developer.mozilla.org/en-US/docs/Web/API/Request/Request#options)                                                                                        | :heavy_minus_sign:                                                                                                                                                             | Options that are passed to the underlying HTTP request. This can be used to inject extra headers for examples. All `Request` options, except `method` and `body`, are allowed. |
| `options.retries`                                                                                                                                                              | [RetryConfig](../../lib/utils/retryconfig.md)                                                                                                                                  | :heavy_minus_sign:                                                                                                                                                             | Enables retrying HTTP requests under certain failure conditions.                                                                                                               |
...
async function run() {
  const result = await discord.applications.get({
    applicationId: "<value>",
  });
...
```typescript
import { DiscordCore } from "discord-sdk/core.js";
import { applicationsGet } from "discord-sdk/funcs/applicationsGet.js";
...
async function run() {
  const result = await discord.applications.update({
    applicationId: "<value>",
...
```typescript
import { DiscordCore } from "discord-sdk/core.js";
import { applicationsUpdate } from "discord-sdk/funcs/applicationsUpdate.js";
...
async function run() {
  const res = await applicationsUpdate(discord, {
    applicationId: "<value>",
    applicationFormPartial: {},
  });
