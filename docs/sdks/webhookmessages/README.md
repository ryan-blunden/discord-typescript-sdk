...
async function run() {
  await discord.webhookMessages.deleteOriginal({
    webhookId: "<value>",
    webhookToken: "<value>",
  });
...
import { webhookMessagesDeleteOriginal } from "@ryan.blunden/discord-sdk/funcs/webhookMessagesDeleteOriginal.js";
...
async function run() {
  const res = await webhookMessagesDeleteOriginal(discord, {
    webhookId: "<value>",
    webhookToken: "<value>",
  });
...
async function run() {
  const result = await discord.webhookMessages.updateMultipart({
    webhookId: "<value>",
    webhookToken: "<value>",
    messageId: "<value>",
    requestBody: {},
...
```typescript
import { DiscordCore } from "@ryan.blunden/discord-sdk/core.js";
import { webhookMessagesUpdateMultipart } from "@ryan.blunden/discord-sdk/funcs/webhookMessagesUpdateMultipart.js";
...
async function run() {
  const res = await webhookMessagesUpdateMultipart(discord, {
    webhookId: "<value>",
    webhookToken: "<value>",
    messageId: "<value>",
    requestBody: {},
...
async function run() {
  const result = await discord.webhookMessages.updateJson({
    webhookId: "<value>",
    webhookToken: "<value>",
    messageId: "<value>",
...
```typescript
import { DiscordCore } from "@ryan.blunden/discord-sdk/core.js";
import { webhookMessagesUpdateJson } from "@ryan.blunden/discord-sdk/funcs/webhookMessagesUpdateJson.js";
...
async function run() {
  const res = await webhookMessagesUpdateJson(discord, {
    webhookId: "<value>",
    webhookToken: "<value>",
    messageId: "<value>",
    incomingWebhookUpdateRequestPartial: {},
...
async function run() {
  const result = await discord.webhookMessages.updateForm({
    webhookId: "<value>",
    webhookToken: "<value>",
    messageId: "<value>",
    incomingWebhookUpdateRequestPartial: {},
...
```typescript
import { DiscordCore } from "@ryan.blunden/discord-sdk/core.js";
import { webhookMessagesUpdateForm } from "@ryan.blunden/discord-sdk/funcs/webhookMessagesUpdateForm.js";
...
async function run() {
  const res = await webhookMessagesUpdateForm(discord, {
    webhookId: "<value>",
    webhookToken: "<value>",
    messageId: "<value>",
    incomingWebhookUpdateRequestPartial: {},
