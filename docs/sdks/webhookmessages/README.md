...
async function run() {
  const result = await discord.webhookMessages.getOriginal({
    webhookId: "<value>",
    webhookToken: "<value>",
  });
...
import { webhookMessagesGetOriginal } from "@ryan.blunden/discord-sdk/funcs/webhookMessagesGetOriginal.js";
...
async function run() {
  const res = await webhookMessagesGetOriginal(discord, {
    webhookId: "<value>",
    webhookToken: "<value>",
  });
