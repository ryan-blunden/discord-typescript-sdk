...
async function run() {
  const result = await discord.guildBans.bulkBan({
    guildId: "<value>",
    requestBody: {
      userIds: [
        "<value>",
...
import { guildBansBulkBan } from "@ryan.blunden/discord-sdk/funcs/guildBansBulkBan.js";
...
async function run() {
  const res = await guildBansBulkBan(discord, {
    guildId: "<value>",
    requestBody: {
      userIds: [
        "<value>",
...
async function run() {
  const result = await discord.guildBans.get({
    guildId: "<value>",
    userId: "<value>",
  });
...
```typescript
import { DiscordCore } from "@ryan.blunden/discord-sdk/core.js";
import { guildBansGet } from "@ryan.blunden/discord-sdk/funcs/guildBansGet.js";
...
async function run() {
  const res = await guildBansGet(discord, {
    guildId: "<value>",
    userId: "<value>",
  });
...
async function run() {
  const result = await discord.guildBans.list({
    guildId: "<value>",
  });
...
```typescript
import { DiscordCore } from "@ryan.blunden/discord-sdk/core.js";
import { guildBansList } from "@ryan.blunden/discord-sdk/funcs/guildBansList.js";
...
async function run() {
  const res = await guildBansList(discord, {
    guildId: "<value>",
  });
