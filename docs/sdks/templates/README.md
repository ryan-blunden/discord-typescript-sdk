...
async function run() {
  const result = await discord.guilds.templates.get({
    code: "<value>",
  });
...
import { guildsTemplatesGet } from "@ryan.blunden/discord-sdk/funcs/guildsTemplatesGet.js";
...
async function run() {
  const res = await guildsTemplatesGet(discord, {
    code: "<value>",
  });
...
async function run() {
  const result = await discord.guilds.templates.create({
    code: "<value>",
    requestBody: {
      name: "<value>",
    },
...
```typescript
import { DiscordCore } from "@ryan.blunden/discord-sdk/core.js";
import { guildsTemplatesCreate } from "@ryan.blunden/discord-sdk/funcs/guildsTemplatesCreate.js";
...
async function run() {
  const res = await guildsTemplatesCreate(discord, {
    code: "<value>",
    requestBody: {
      name: "<value>",
    },
...
async function run() {
  const result = await discord.guilds.templates.update({
    guildId: "<value>",
    code: "<value>",
    requestBody: {},
  });
...
```typescript
import { DiscordCore } from "@ryan.blunden/discord-sdk/core.js";
import { guildsTemplatesUpdate } from "@ryan.blunden/discord-sdk/funcs/guildsTemplatesUpdate.js";
...
async function run() {
  const res = await guildsTemplatesUpdate(discord, {
    guildId: "<value>",
    code: "<value>",
    requestBody: {},
  });
