...
async function run() {
  const result = await discord.groupDmUsers.add({
    channelId: "<value>",
    userId: "<value>",
    requestBody: {},
  });
...
import { groupDmUsersAdd } from "@ryan.blunden/discord-sdk/funcs/groupDmUsersAdd.js";
...
async function run() {
  const res = await groupDmUsersAdd(discord, {
    channelId: "<value>",
    userId: "<value>",
    requestBody: {},
  });
