...
async function run() {
  const result = await discord.guildsChannels.create({
    guildId: "<value>",
...
import { guildsChannelsCreate } from "@ryan.blunden/discord-sdk/funcs/guildsChannelsCreate.js";
...
async function run() {
  const res = await guildsChannelsCreate(discord, {
    guildId: "<value>",
    createGuildChannelRequest: {
      name: "<value>",
    },
