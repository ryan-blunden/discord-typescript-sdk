...
async function run() {
  const result = await discord.entitlements.create({
    applicationId: "<value>",
...
import { entitlementsCreate } from "@ryan.blunden/discord-sdk/funcs/entitlementsCreate.js";
...
async function run() {
  const res = await entitlementsCreate(discord, {
    applicationId: "<value>",
    createEntitlementRequestData: {
      skuId: "<value>",
      ownerId: "<value>",
