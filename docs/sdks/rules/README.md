...
async function run() {
  const result = await discord.guilds.autoModeration.rules.update({
    guildId: "<value>",
    ruleId: "<value>",
    requestBody: {},
  });
...
import { guildsAutoModerationRulesUpdate } from "@ryan.blunden/discord-sdk/funcs/guildsAutoModerationRulesUpdate.js";
...
async function run() {
  const res = await guildsAutoModerationRulesUpdate(discord, {
    guildId: "<value>",
    ruleId: "<value>",
    requestBody: {},
  });
