...
async function run() {
  const result = await discord.scheduledEvents.create({
    guildId: "<value>",
    requestBody: {
      name: "<value>",
...
import { scheduledEventsCreate } from "@ryan.blunden/discord-sdk/funcs/scheduledEventsCreate.js";
...
async function run() {
  const res = await scheduledEventsCreate(discord, {
    guildId: "<value>",
    requestBody: {
      name: "<value>",
