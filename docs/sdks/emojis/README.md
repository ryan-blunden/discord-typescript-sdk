...
async function run() {
  const result = await discord.applications.emojis.get({
    applicationId: "<value>",
    emojiId: "<value>",
  });
...
import { applicationsEmojisGet } from "discord-sdk/funcs/applicationsEmojisGet.js";
...
async function run() {
  const res = await applicationsEmojisGet(discord, {
    applicationId: "<value>",
    emojiId: "<value>",
  });
...
async function run() {
  const result = await discord.applications.emojis.list({
    applicationId: "<value>",
  });
...
```typescript
import { DiscordCore } from "discord-sdk/core.js";
import { applicationsEmojisList } from "discord-sdk/funcs/applicationsEmojisList.js";
...
async function run() {
  const res = await applicationsEmojisList(discord, {
    applicationId: "<value>",
  });
