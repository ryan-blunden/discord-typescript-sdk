...
async function run() {
  const result = await discord.applications.commands.get({
...
import { applicationsCommandsGet } from "@ryan.blunden/discord-sdk/funcs/applicationsCommandsGet.js";
...
async function run() {
  const res = await applicationsCommandsGet(discord, {
    botToken: process.env["DISCORD_BOT_TOKEN"] ?? "",
  }, {
    applicationId: "<value>",
    commandId: "<value>",
...
async function run() {
  const result = await discord.applications.commands.create({
    botToken: process.env["DISCORD_BOT_TOKEN"] ?? "",
  }, {
    applicationId: "<value>",
...
```typescript
import { DiscordCore } from "@ryan.blunden/discord-sdk/core.js";
import { applicationsCommandsCreate } from "@ryan.blunden/discord-sdk/funcs/applicationsCommandsCreate.js";
