...
async function run() {
  const result = await discord.messageThreads.create({
    channelId: "<value>",
    messageId: "<value>",
...
import { messageThreadsCreate } from "@ryan.blunden/discord-sdk/funcs/messageThreadsCreate.js";
...
async function run() {
  const res = await messageThreadsCreate(discord, {
    channelId: "<value>",
    messageId: "<value>",
    createTextThreadWithMessageRequest: {
      name: "<value>",
