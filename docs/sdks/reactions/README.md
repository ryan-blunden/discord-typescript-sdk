...
async function run() {
  await discord.channels.messages.reactions.add({
    channelId: "<value>",
    messageId: "<value>",
    emojiName: "<value>",
  });
...
import { channelsMessagesReactionsAdd } from "@ryan.blunden/discord-sdk/funcs/channelsMessagesReactionsAdd.js";
...
async function run() {
  const res = await channelsMessagesReactionsAdd(discord, {
    channelId: "<value>",
    messageId: "<value>",
    emojiName: "<value>",
  });
