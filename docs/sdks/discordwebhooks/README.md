...
async function run() {
  const result = await discord.channels.webhooks.create({
    channelId: "<value>",
    requestBody: {
      name: "<value>",
    },
...
import { channelsWebhooksCreate } from "@ryan.blunden/discord-sdk/funcs/channelsWebhooksCreate.js";
...
async function run() {
  const res = await channelsWebhooksCreate(discord, {
    channelId: "<value>",
    requestBody: {
      name: "<value>",
    },
