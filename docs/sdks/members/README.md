...
async function run() {
  await discord.guilds.members.delete({
    guildId: "<value>",
    userId: "<value>",
  });
...
import { guildsMembersDelete } from "@ryan.blunden/discord-sdk/funcs/guildsMembersDelete.js";
...
async function run() {
  const res = await guildsMembersDelete(discord, {
    guildId: "<value>",
    userId: "<value>",
  });
