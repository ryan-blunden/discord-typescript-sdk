...
async function run() {
  const result = await discord.guilds.soundboardSounds.update({
    guildId: "<value>",
    soundId: "<value>",
...
import { guildsSoundboardSoundsUpdate } from "@ryan.blunden/discord-sdk/funcs/guildsSoundboardSoundsUpdate.js";
...
async function run() {
  const res = await guildsSoundboardSoundsUpdate(discord, {
    guildId: "<value>",
    soundId: "<value>",
    soundboardPatchRequestPartial: {},
  });
