...
async function run() {
  const result = await discord.channels.threads.create({
    channelId: "<value>",
    requestBody: {
      name: "<value>",
      message: {},
...
import { channelsThreadsCreate } from "@ryan.blunden/discord-sdk/funcs/channelsThreadsCreate.js";
...
async function run() {
  const res = await channelsThreadsCreate(discord, {
    channelId: "<value>",
    requestBody: {
      name: "<value>",
      message: {},
