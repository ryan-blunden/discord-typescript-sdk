...
async function run() {
  await discord.guildMemberRoles.add({
    guildId: "<value>",
    userId: "<value>",
    roleId: "<value>",
  });
...
import { guildMemberRolesAdd } from "@ryan.blunden/discord-sdk/funcs/guildMemberRolesAdd.js";
...
async function run() {
  const res = await guildMemberRolesAdd(discord, {
    guildId: "<value>",
    userId: "<value>",
    roleId: "<value>",
  });
...
async function run() {
  await discord.guildMemberRoles.delete({
    guildId: "<value>",
    userId: "<value>",
    roleId: "<value>",
  });
...
```typescript
import { DiscordCore } from "@ryan.blunden/discord-sdk/core.js";
import { guildMemberRolesDelete } from "@ryan.blunden/discord-sdk/funcs/guildMemberRolesDelete.js";
...
async function run() {
  const res = await guildMemberRolesDelete(discord, {
    guildId: "<value>",
    userId: "<value>",
    roleId: "<value>",
  });
