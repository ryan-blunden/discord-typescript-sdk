...
async function run() {
  await discord.guilds.integrations.delete({
    guildId: "<value>",
    integrationId: "<value>",
  });
...
import { guildsIntegrationsDelete } from "@ryan.blunden/discord-sdk/funcs/guildsIntegrationsDelete.js";
...
async function run() {
  const res = await guildsIntegrationsDelete(discord, {
    guildId: "<value>",
    integrationId: "<value>",
  });
