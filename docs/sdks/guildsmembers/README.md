...
async function run() {
  const result = await discord.guildsMembers.updateMe({
    guildId: "<value>",
    requestBody: {},
  });
...
import { guildsMembersUpdateMe } from "@ryan.blunden/discord-sdk/funcs/guildsMembersUpdateMe.js";
...
async function run() {
  const res = await guildsMembersUpdateMe(discord, {
    guildId: "<value>",
    requestBody: {},
  });
...
async function run() {
  const result = await discord.guildsMembers.get({
    guildId: "<value>",
    userId: "<value>",
  });
...
```typescript
import { DiscordCore } from "@ryan.blunden/discord-sdk/core.js";
import { guildsMembersGet } from "@ryan.blunden/discord-sdk/funcs/guildsMembersGet.js";
...
async function run() {
  const res = await guildsMembersGet(discord, {
    guildId: "<value>",
    userId: "<value>",
  });
...
async function run() {
  const result = await discord.guildsMembers.update({
    guildId: "<value>",
    userId: "<value>",
    requestBody: {},
  });
...
```typescript
import { DiscordCore } from "@ryan.blunden/discord-sdk/core.js";
import { guildsMembersUpdate } from "@ryan.blunden/discord-sdk/funcs/guildsMembersUpdate.js";
...
async function run() {
  const res = await guildsMembersUpdate(discord, {
    guildId: "<value>",
    userId: "<value>",
    requestBody: {},
  });
