...
async function run() {
  const result = await discord.guildSoundboardSounds.get({
    guildId: "<value>",
    soundId: "<value>",
  });
...
import { guildSoundboardSoundsGet } from "@ryan.blunden/discord-sdk/funcs/guildSoundboardSoundsGet.js";
...
async function run() {
  const res = await guildSoundboardSoundsGet(discord, {
    guildId: "<value>",
    soundId: "<value>",
  });
...
async function run() {
  const result = await discord.guildSoundboardSounds.update({
    guildId: "<value>",
    soundId: "<value>",
...
```typescript
import { DiscordCore } from "@ryan.blunden/discord-sdk/core.js";
import { guildSoundboardSoundsUpdate } from "@ryan.blunden/discord-sdk/funcs/guildSoundboardSoundsUpdate.js";
...
async function run() {
  const res = await guildSoundboardSoundsUpdate(discord, {
    guildId: "<value>",
    soundId: "<value>",
    soundboardPatchRequestPartial: {},
  });
