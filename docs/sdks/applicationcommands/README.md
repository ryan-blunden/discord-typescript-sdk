...
async function run() {
  const result = await discord.applicationCommands.createForGuild({
...
import { applicationCommandsCreateForGuild } from "discord-sdk/funcs/applicationCommandsCreateForGuild.js";
...
async function run() {
  const res = await applicationCommandsCreateForGuild(discord, {
    botToken: process.env["DISCORD_BOT_TOKEN"] ?? "",
  }, {
    applicationId: "<value>",
    guildId: "<value>",
...
```typescript
import { DiscordCore } from "discord-sdk/core.js";
import { applicationCommandsDelete } from "discord-sdk/funcs/applicationCommandsDelete.js";
...
```typescript
import { DiscordCore } from "discord-sdk/core.js";
import { applicationCommandsBulkSet } from "discord-sdk/funcs/applicationCommandsBulkSet.js";
