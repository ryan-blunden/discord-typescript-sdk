...
async function run() {
  await discord.channels.permissions.setOverwrite({
    channelId: "<value>",
    overwriteId: "<value>",
    requestBody: {},
  });
...
import { channelsPermissionsSetOverwrite } from "@ryan.blunden/discord-sdk/funcs/channelsPermissionsSetOverwrite.js";
...
async function run() {
  const res = await channelsPermissionsSetOverwrite(discord, {
    channelId: "<value>",
    overwriteId: "<value>",
    requestBody: {},
  });
