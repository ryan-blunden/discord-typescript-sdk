...
async function run() {
  const result = await discord.threadMembers.get({
    channelId: "<value>",
    userId: "<value>",
  });
...
import { threadMembersGet } from "@ryan.blunden/discord-sdk/funcs/threadMembersGet.js";
...
async function run() {
  const res = await threadMembersGet(discord, {
    channelId: "<value>",
    userId: "<value>",
  });
...
```typescript
import { DiscordCore } from "@ryan.blunden/discord-sdk/core.js";
import { threadMembersDelete } from "@ryan.blunden/discord-sdk/funcs/threadMembersDelete.js";
