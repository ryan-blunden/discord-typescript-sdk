...
```typescript
import { DiscordCore } from "@ryan.blunden/discord-sdk/core.js";
import { webhooksExecuteGithubCompatible } from "@ryan.blunden/discord-sdk/funcs/webhooksExecuteGithubCompatible.js";
...
```typescript
import { DiscordCore } from "@ryan.blunden/discord-sdk/core.js";
import { webhooksExecuteSlackCompatible } from "@ryan.blunden/discord-sdk/funcs/webhooksExecuteSlackCompatible.js";
...
async function run() {
  const result = await discord.webhooks.getByToken({
    webhookId: "<value>",
    webhookToken: "<value>",
  });
...
```typescript
import { DiscordCore } from "@ryan.blunden/discord-sdk/core.js";
import { webhooksGetByToken } from "@ryan.blunden/discord-sdk/funcs/webhooksGetByToken.js";
...
async function run() {
  const res = await webhooksGetByToken(discord, {
    webhookId: "<value>",
    webhookToken: "<value>",
  });
...
async function run() {
  await discord.webhooks.deleteByToken({
    webhookId: "<value>",
    webhookToken: "<value>",
  });
...
```typescript
import { DiscordCore } from "@ryan.blunden/discord-sdk/core.js";
import { webhooksDeleteByToken } from "@ryan.blunden/discord-sdk/funcs/webhooksDeleteByToken.js";
...
async function run() {
  const res = await webhooksDeleteByToken(discord, {
    webhookId: "<value>",
    webhookToken: "<value>",
  });
...
async function run() {
  const result = await discord.webhooks.updateByToken({
    webhookId: "<value>",
    webhookToken: "<value>",
    requestBody: {},
  });
...
```typescript
import { DiscordCore } from "@ryan.blunden/discord-sdk/core.js";
import { webhooksUpdateByToken } from "@ryan.blunden/discord-sdk/funcs/webhooksUpdateByToken.js";
...
async function run() {
  const res = await webhooksUpdateByToken(discord, {
    webhookId: "<value>",
    webhookToken: "<value>",
    requestBody: {},
  });
