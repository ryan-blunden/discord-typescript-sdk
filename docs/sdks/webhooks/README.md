...
* [executeSlackWebhook](#executeslackwebhook)
...
async function run() {
  const result = await discord.webhooks.executeSlackWebhook({
    webhookId: "<value>",
    webhookToken: "<value>",
    slackWebhook: {},
  });
...
```typescript
import { DiscordCore } from "@ryan.blunden/discord-sdk/core.js";
import { webhooksExecuteSlackWebhook } from "@ryan.blunden/discord-sdk/funcs/webhooksExecuteSlackWebhook.js";
...
async function run() {
  const res = await webhooksExecuteSlackWebhook(discord, {
    webhookId: "<value>",
    webhookToken: "<value>",
    slackWebhook: {},
  });
