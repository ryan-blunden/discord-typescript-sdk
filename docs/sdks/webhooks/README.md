...
* [listForChannel](#listforchannel) - Returns a list of channel webhook objects. Requires the MANAGE_WEBHOOKS permission.
* [create](#create) - Creates a new webhook and returns a webhook object on success. Requires the MANAGE_WEBHOOKS permission. Fires a Webhooks Update Gateway event.
* [listForGuild](#listforguild) - Returns a list of guild webhook objects. Requires the MANAGE_WEBHOOKS permission.
* [get](#get) - Returns the new webhook object for the given id.
...
* [getOriginalMessage](#getoriginalmessage) - Returns the initial webhook message.
* [deleteOriginalMessage](#deleteoriginalmessage) - Deletes the initial webhook message.
* [updateOriginalMessageJson](#updateoriginalmessagejson) - Edits the initial webhook message.
* [updateOriginalMessageForm](#updateoriginalmessageform) - Edits the initial webhook message.
* [updateOriginalMessageMultipart](#updateoriginalmessagemultipart) - Edits the initial webhook message.
* [getMessage](#getmessage) - Returns a previously-sent webhook message from the same token. Returns a message object on success.
* [deleteMessage](#deletemessage) - Deletes a message that was created by the webhook. Returns a 204 No Content response on success.
* [updateMessageJson](#updatemessagejson) - Edits a previously-sent webhook message from the same token. Returns a message object on success.
* [updateMessageForm](#updatemessageform) - Edits a previously-sent webhook message from the same token. Returns a message object on success.
* [updateMessageMultipart](#updatemessagemultipart) - Edits a previously-sent webhook message from the same token. Returns a message object on success.
* [executeSlack](#executeslack) - Refer to Slack's documentation for more information. We do not support Slack's channel, icon_emoji, mrkdwn, or mrkdwn_in properties.
...
async function run() {
  const result = await discord.webhooks.listForChannel({
    channelId: "<value>",
  });
...
import { webhooksListForChannel } from "@ryan.blunden/discord-sdk/funcs/webhooksListForChannel.js";
...
async function run() {
  const result = await discord.webhooks.create({
    channelId: "<value>",
    requestBody: {
      name: "<value>",
    },
...
```typescript
import { DiscordCore } from "@ryan.blunden/discord-sdk/core.js";
import { webhooksCreate } from "@ryan.blunden/discord-sdk/funcs/webhooksCreate.js";
...
async function run() {
  const res = await webhooksCreate(discord, {
    channelId: "<value>",
    requestBody: {
      name: "<value>",
    },
...
async function run() {
  const result = await discord.webhooks.listForGuild({
    guildId: "<value>",
  });
...
```typescript
import { DiscordCore } from "@ryan.blunden/discord-sdk/core.js";
import { webhooksListForGuild } from "@ryan.blunden/discord-sdk/funcs/webhooksListForGuild.js";
...
```typescript
import { DiscordCore } from "@ryan.blunden/discord-sdk/core.js";
import { webhooksGet } from "@ryan.blunden/discord-sdk/funcs/webhooksGet.js";
...
```typescript
import { DiscordCore } from "@ryan.blunden/discord-sdk/core.js";
import { webhooksDelete } from "@ryan.blunden/discord-sdk/funcs/webhooksDelete.js";
...
```typescript
import { DiscordCore } from "@ryan.blunden/discord-sdk/core.js";
import { webhooksUpdate } from "@ryan.blunden/discord-sdk/funcs/webhooksUpdate.js";
...
```typescript
import { DiscordCore } from "@ryan.blunden/discord-sdk/core.js";
import { webhooksGetWithToken } from "@ryan.blunden/discord-sdk/funcs/webhooksGetWithToken.js";
...
```typescript
import { DiscordCore } from "@ryan.blunden/discord-sdk/core.js";
import { webhooksDeleteWithToken } from "@ryan.blunden/discord-sdk/funcs/webhooksDeleteWithToken.js";
...
```typescript
import { DiscordCore } from "@ryan.blunden/discord-sdk/core.js";
import { webhooksUpdateWithToken } from "@ryan.blunden/discord-sdk/funcs/webhooksUpdateWithToken.js";
...
```typescript
import { DiscordCore } from "@ryan.blunden/discord-sdk/core.js";
import { webhooksExecuteGithub } from "@ryan.blunden/discord-sdk/funcs/webhooksExecuteGithub.js";
...
```typescript
import { DiscordCore } from "@ryan.blunden/discord-sdk/core.js";
import { webhooksGetOriginalMessage } from "@ryan.blunden/discord-sdk/funcs/webhooksGetOriginalMessage.js";
...
```typescript
import { DiscordCore } from "@ryan.blunden/discord-sdk/core.js";
import { webhooksDeleteOriginalMessage } from "@ryan.blunden/discord-sdk/funcs/webhooksDeleteOriginalMessage.js";
...
```typescript
import { DiscordCore } from "@ryan.blunden/discord-sdk/core.js";
import { webhooksUpdateOriginalMessageJson } from "@ryan.blunden/discord-sdk/funcs/webhooksUpdateOriginalMessageJson.js";
...
```typescript
import { DiscordCore } from "@ryan.blunden/discord-sdk/core.js";
import { webhooksUpdateOriginalMessageForm } from "@ryan.blunden/discord-sdk/funcs/webhooksUpdateOriginalMessageForm.js";
...
```typescript
import { DiscordCore } from "@ryan.blunden/discord-sdk/core.js";
import { webhooksUpdateOriginalMessageMultipart } from "@ryan.blunden/discord-sdk/funcs/webhooksUpdateOriginalMessageMultipart.js";
...
```typescript
import { DiscordCore } from "@ryan.blunden/discord-sdk/core.js";
import { webhooksGetMessage } from "@ryan.blunden/discord-sdk/funcs/webhooksGetMessage.js";
...
```typescript
import { DiscordCore } from "@ryan.blunden/discord-sdk/core.js";
import { webhooksDeleteMessage } from "@ryan.blunden/discord-sdk/funcs/webhooksDeleteMessage.js";
...
```typescript
import { DiscordCore } from "@ryan.blunden/discord-sdk/core.js";
import { webhooksUpdateMessageJson } from "@ryan.blunden/discord-sdk/funcs/webhooksUpdateMessageJson.js";
...
```typescript
import { DiscordCore } from "@ryan.blunden/discord-sdk/core.js";
import { webhooksUpdateMessageForm } from "@ryan.blunden/discord-sdk/funcs/webhooksUpdateMessageForm.js";
...
```typescript
import { DiscordCore } from "@ryan.blunden/discord-sdk/core.js";
import { webhooksUpdateMessageMultipart } from "@ryan.blunden/discord-sdk/funcs/webhooksUpdateMessageMultipart.js";
...
```typescript
import { DiscordCore } from "@ryan.blunden/discord-sdk/core.js";
import { webhooksExecuteSlack } from "@ryan.blunden/discord-sdk/funcs/webhooksExecuteSlack.js";
