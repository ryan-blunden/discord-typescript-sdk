...
async function run() {
  await discord.channels.messages.delete({
    channelId: "<value>",
    messageId: "<value>",
  });
...
import { channelsMessagesDelete } from "@ryan.blunden/discord-sdk/funcs/channelsMessagesDelete.js";
...
async function run() {
  const res = await channelsMessagesDelete(discord, {
    channelId: "<value>",
    messageId: "<value>",
  });
