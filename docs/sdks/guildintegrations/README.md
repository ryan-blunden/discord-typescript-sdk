...
async function run() {
  await discord.guildIntegrations.delete({
    guildId: "<value>",
    integrationId: "<value>",
  });
...
import { guildIntegrationsDelete } from "@ryan.blunden/discord-sdk/funcs/guildIntegrationsDelete.js";
...
async function run() {
  const res = await guildIntegrationsDelete(discord, {
    guildId: "<value>",
    integrationId: "<value>",
  });
