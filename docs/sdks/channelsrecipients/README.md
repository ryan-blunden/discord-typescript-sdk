...
async function run() {
  const result = await discord.channelsRecipients.addGroupDmUser({
    channelId: "<value>",
    userId: "<value>",
    requestBody: {},
  });
...
import { channelsRecipientsAddGroupDmUser } from "@ryan.blunden/discord-sdk/funcs/channelsRecipientsAddGroupDmUser.js";
...
async function run() {
  const res = await channelsRecipientsAddGroupDmUser(discord, {
    channelId: "<value>",
    userId: "<value>",
    requestBody: {},
  });
