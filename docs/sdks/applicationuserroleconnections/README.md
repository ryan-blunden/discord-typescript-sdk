# ApplicationUserRoleConnections
(*applicationUserRoleConnections*)
...
async function run() {
  const result = await discord.applicationUserRoleConnections.update({
    applicationId: "<value>",
    requestBody: {},
  });
...
import { applicationUserRoleConnectionsUpdate } from "@ryan.blunden/discord-sdk/funcs/applicationUserRoleConnectionsUpdate.js";
...
async function run() {
  const res = await applicationUserRoleConnectionsUpdate(discord, {
    applicationId: "<value>",
    requestBody: {},
  });
