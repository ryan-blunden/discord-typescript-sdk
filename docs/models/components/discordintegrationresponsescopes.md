# DiscordIntegrationResponseScopes
...
```typescript
import { DiscordIntegrationResponseScopes } from "@ryan.blunden/discord-sdk/models/components";

let value: DiscordIntegrationResponseScopes = "activities.invites.write";
```
