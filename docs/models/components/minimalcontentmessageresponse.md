...
```typescript
import { MinimalContentMessageResponse } from "discord-sdk/models/components";
...
let value: MinimalContentMessageResponse = {
  ...
  attachments: [
    {
      ...
      size: 183804,
      url: "https://juvenile-corporation.org",
      proxyUrl: "https://spanish-airmail.biz/",
    },
  ],
  embeds: [
    {
  ...
  timestamp: new Date("2024-06-16T11:27:10.944Z"),
  flags: 536427,
  components: [
    {
      id: 428898,
