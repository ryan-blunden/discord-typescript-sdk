...
```typescript
import { CreateTextThreadWithoutMessageRequestType } from "@ryan.blunden/discord-sdk/models/components";

let value: CreateTextThreadWithoutMessageRequestType = 13;
```
