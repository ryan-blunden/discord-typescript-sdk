...
```typescript
import { ApplicationOAuth2InstallParamsScopes } from "@ryan.blunden/discord-sdk/models/components";

let value: ApplicationOAuth2InstallParamsScopes = "messages.read";
```
