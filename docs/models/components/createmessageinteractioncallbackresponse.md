...
```typescript
import { CreateMessageInteractionCallbackResponse } from "@ryan.blunden/discord-sdk/models/components";

let value: CreateMessageInteractionCallbackResponse = {
  type: 13,
  message: {
    type: 28,
    content: "<value>",
...
| ---------------------------------------------------------------------------------------------------------------------------------- | ---------------------------------------------------------------------------------------------------------------------------------- | ---------------------------------------------------------------------------------------------------------------------------------- | ---------------------------------------------------------------------------------------------------------------------------------- |
| `type`                                                                                                                             | [components.CreateMessageInteractionCallbackResponseType](../../models/components/createmessageinteractioncallbackresponsetype.md) | :heavy_check_mark:                                                                                                                 | N/A                                                                                                                                |
