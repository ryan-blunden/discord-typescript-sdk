...
```typescript
import { BasicMessageResponse } from "discord-sdk/models/components";
...
let value: BasicMessageResponse = {
  ...
  attachments: [
    {
      ...
      size: 103745,
      url: "https://corrupt-invite.info",
      proxyUrl: "https://first-reconsideration.com",
    },
  ],
  embeds: [
    {
  ...
  timestamp: new Date("2024-10-13T03:45:54.403Z"),
  flags: 98955,
  components: [
    {
      id: 173429,
