...
```typescript
import { UpdateRoleRequestPartial } from "@ryan.blunden/discord-sdk/models/components";

let value: UpdateRoleRequestPartial = {};
```
...
| `colors`                                                       | [components.RoleColors](../../models/components/rolecolors.md) | :heavy_minus_sign:                                             | N/A                                                            |
