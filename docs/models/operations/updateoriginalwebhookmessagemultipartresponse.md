# UpdateOriginalWebhookMessageMultipartResponse

## Example Usage

```typescript
import { UpdateOriginalWebhookMessageMultipartResponse } from "@ryan.blunden/discord-sdk/models/operations";

let value: UpdateOriginalWebhookMessageMultipartResponse = {
  headers: {},
  result: {
    type: 16,
    content: "<value>",
